...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if Application.MessageBox(pchar('Deseja adicionar o valor da Devolução '
          + 'como credito para o cliente?'), 'Devolução de Venda',
  ...
  begin
    ...
    if Dados.qryConsulta.Fields[0].AsFloat = 0 then
      ShowMessage('Venda não foi feita em Dinheiro!');
