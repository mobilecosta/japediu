object Dados: TDados
  ...
  object qryPessoas: TFDQuery
    ...
    object qryPessoasFK_VENDEDOR: TIntegerField
  ...
  object qryProdutos: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select FIRST 100 PRO.*, gr.descricao grupo_sl, m.descricao marca' +
        '_s1 from Produto PRO'
    ...
    object qryProdutosMARCA_S1: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'MARCA_S1'
      Origin = 'DESCRICAO'
      ProviderFlags = []
  ...
  object qryCR: TFDQuery
    ...
    object qryCRMULTA: TFMTBCDField
      FieldName = 'MULTA'
      Origin = 'MULTA'
      Precision = 18
      Size = 2
  ...
  object qrySomaRec: TFDQuery
    Connection = Conexao
    SQL.Strings = (
      'select sum(crr.juros) juros,'
      'sum(crr.desconto) desconto, sum(crr.valor_parcela) valor ,'
      'sum(crr.valor_recebido) recebido ,sum(crr.multa) muta '
      'from crrecebimento crr'
      'where'
      'crr.fkreceber=:id')
    Left = 161
    Top = 240
    ...
    object qrySomaRecMUTA: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'MUTA'
      Origin = 'MUTA'
      ProviderFlags = []
  ...
  object qryEmpresa: TFDQuery
    ...
    object qryEmpresaMENSALIDADE: TStringField
      FieldName = 'MENSALIDADE'
      Origin = 'MENSALIDADE'
      Size = 6
    end
    object qryEmpresaACESSTOKEN_SOFTHOUSE: TStringField
      FieldName = 'ACESSTOKEN_SOFTHOUSE'
      Origin = 'ACESSTOKEN_SOFTHOUSE'
      Size = 250
    end
    object qryEmpresaENCARTE: TStringField
      FieldName = 'ENCARTE'
      Origin = 'ENCARTE'
      Size = 1
    end
    object qryEmpresaPROMO_LOTE: TStringField
      FieldName = 'PROMO_LOTE'
      Origin = 'PROMO_LOTE'
      Size = 1
    end
    object qryEmpresaEDITAR_RELATORIOS: TStringField
      FieldName = 'EDITAR_RELATORIOS'
      Origin = 'EDITAR_RELATORIOS'
      Size = 1
    end
    object qryEmpresaGERAR_NFE_PDV: TStringField
      FieldName = 'GERAR_NFE_PDV'
      Origin = 'GERAR_NFE_PDV'
      Size = 1
    end
    ...
    object qryEmpresaBACKGROUND: TBlobField
      FieldName = 'BACKGROUND'
      Origin = 'BACKGROUND'
    end
    object qryEmpresaQRCODE: TBlobField
      FieldName = 'QRCODE'
      Origin = 'QRCODE'
    end
    object qryEmpresaBARRA_SUPERIOR: TStringField
      FieldName = 'BARRA_SUPERIOR'
      Origin = 'BARRA_SUPERIOR'
    end
    object qryEmpresaBARRA_INFERIOR: TStringField
      FieldName = 'BARRA_INFERIOR'
      Origin = 'BARRA_INFERIOR'
    end
    object qryEmpresaIMPRIME_VIALOJA: TStringField
      FieldName = 'IMPRIME_VIALOJA'
      Origin = 'IMPRIME_VIALOJA'
      Size = 1
    end
    object qryEmpresaCOR_PAINEL: TStringField
      FieldName = 'COR_PAINEL'
      Origin = 'COR_PAINEL'
    end
    object qryEmpresaFONTE_PAINEL: TStringField
      FieldName = 'FONTE_PAINEL'
      Origin = 'FONTE_PAINEL'
      Size = 100
    end
    object qryEmpresaUSAR_BOTAO1: TStringField
      FieldName = 'USAR_BOTAO1'
      Origin = 'USAR_BOTAO1'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO2: TStringField
      FieldName = 'USAR_BOTAO2'
      Origin = 'USAR_BOTAO2'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO3: TStringField
      FieldName = 'USAR_BOTAO3'
      Origin = 'USAR_BOTAO3'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO4: TStringField
      FieldName = 'USAR_BOTAO4'
      Origin = 'USAR_BOTAO4'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO5: TStringField
      FieldName = 'USAR_BOTAO5'
      Origin = 'USAR_BOTAO5'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO6: TStringField
      FieldName = 'USAR_BOTAO6'
      Origin = 'USAR_BOTAO6'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO7: TStringField
      FieldName = 'USAR_BOTAO7'
      Origin = 'USAR_BOTAO7'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO8: TStringField
      FieldName = 'USAR_BOTAO8'
      Origin = 'USAR_BOTAO8'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO9: TStringField
      FieldName = 'USAR_BOTAO9'
      Origin = 'USAR_BOTAO9'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO10: TStringField
      FieldName = 'USAR_BOTAO10'
      Origin = 'USAR_BOTAO10'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO11: TStringField
      FieldName = 'USAR_BOTAO11'
      Origin = 'USAR_BOTAO11'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO12: TStringField
      FieldName = 'USAR_BOTAO12'
      Origin = 'USAR_BOTAO12'
      Size = 1
    end
    object qryEmpresaUSAR_BOTAO13: TStringField
      FieldName = 'USAR_BOTAO13'
      Origin = 'USAR_BOTAO13'
      Size = 1
    end
    object qryEmpresaMODULO_FORCA_VENDAS: TStringField
      FieldName = 'MODULO_FORCA_VENDAS'
      Origin = 'MODULO_FORCA_VENDAS'
      Size = 1
    end
    object qryEmpresaMODULO_PDV_MESA: TStringField
      FieldName = 'MODULO_PDV_MESA'
      Origin = 'MODULO_PDV_MESA'
      Size = 1
    end
    object qryEmpresaMODULO_PDV_DELIVERY: TStringField
      FieldName = 'MODULO_PDV_DELIVERY'
      Origin = 'MODULO_PDV_DELIVERY'
      Size = 1
    end
    object qryEmpresaMODULO_WHATSAPP: TStringField
      FieldName = 'MODULO_WHATSAPP'
      Origin = 'MODULO_WHATSAPP'
      Size = 1
    end
    object qryEmpresaMODULO_SPED: TStringField
      FieldName = 'MODULO_SPED'
      Origin = 'MODULO_SPED'
      Size = 1
    end
    object qryEmpresaMODULO_NFE: TStringField
      FieldName = 'MODULO_NFE'
      Origin = 'MODULO_NFE'
      Size = 1
    end
    object qryEmpresaMODULO_NFCE: TStringField
      FieldName = 'MODULO_NFCE'
      Origin = 'MODULO_NFCE'
      Size = 1
    end
    object qryEmpresaMODULO_SAT: TStringField
      FieldName = 'MODULO_SAT'
      Origin = 'MODULO_SAT'
      Size = 1
    end
    object qryEmpresaMODULO_CTE: TStringField
      FieldName = 'MODULO_CTE'
      Origin = 'MODULO_CTE'
      Size = 1
    end
    object qryEmpresaMODULO_MDF: TStringField
      FieldName = 'MODULO_MDF'
      Origin = 'MODULO_MDF'
      Size = 1
    end
    object qryEmpresaMODULO_FISCAL: TStringField
      FieldName = 'MODULO_FISCAL'
      Origin = 'MODULO_FISCAL'
      Size = 1
    end
    object qryEmpresaMODULO_ORDEM_SERVICO: TStringField
      FieldName = 'MODULO_ORDEM_SERVICO'
      Origin = 'MODULO_ORDEM_SERVICO'
      Size = 1
    end
    object qryEmpresaMODULO_BOLETO: TStringField
      FieldName = 'MODULO_BOLETO'
      Origin = 'MODULO_BOLETO'
      Size = 1
    end
  ...
  object qryItensO: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select oi.*, pro.descricao VIRTUAL_PRODUTO, pro.FOTO, pro.pr_ven' +
        'da VIRTUAL_PRECO, pro.unidade VIRTUAL_UNIDADE, pro.LOCALIZACAO V' +
        'IRTUAL_LOCAL, pro.REFERENCIA VIRTUAL_REFERENCIA, gr.DESCRICAO as' +
        ' Grade from orcamento_item oi '
    ...
    object qryItensOFOTO: TBlobField
      AutoGenerateValue = arDefault
      FieldName = 'FOTO'
      Origin = 'FOTO'
      ProviderFlags = []
  ...
  object qryTerminal: TFDQuery
    ...
    object qryTerminalTIPOIMPRESSORA_NFCE: TStringField
      FieldName = 'TIPOIMPRESSORA_NFCE'
      Origin = 'TIPOIMPRESSORA_NFCE'
      Size = 1
    end
  ...
  object qryConfig: TFDQuery
    ...
    object qryConfigEMAILFROM: TStringField
      FieldName = 'EMAILFROM'
      Origin = 'EMAILFROM'
      Size = 200
    end
  ...
  object qryNFCE_M: TFDQuery
    ...
    OnNewRecord = qryNFCE_MNewRecord
    Connection = Conexao
    SQL.Strings = (
    ...
    object qryNFCE_MIP: TStringField
      FieldName = 'IP'
      Origin = 'IP'
    end
    object qryNFCE_MXERRO: TStringField
      FieldName = 'XERRO'
      Origin = 'XERRO'
      Size = 500
    end
  ...
  object QRYNFCE_D: TFDQuery
    ...
    object QRYNFCE_DUNIDADE_TRIBUTAVEL: TStringField
  ...
  object qryCRRecebimento: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CR.*, f.descricao, c.dtvencimento as vencimento, c.doc, c' +
        '.historico FROM CRRECEBIMENTO CR'
      'inner join forma_pagamento f on f.codigo = cr.fk_forma_pgto'
      'inner join creceber c on c.codigo = cr.fkreceber'
      'WHERE'
      'cR.fkRECEBER=:CODIGO'
      'order by 1')
    Left = 464
    ...
    object qryCRRecebimentoFKLOTE: TIntegerField
      FieldName = 'FKLOTE'
      Origin = 'FKLOTE'
    end
    object qryCRRecebimentoMULTA: TFMTBCDField
      FieldName = 'MULTA'
      Origin = 'MULTA'
      Precision = 18
      Size = 2
    end
    object qryCRRecebimentoDESCRICAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object qryCRRecebimentoVENCIMENTO: TDateField
      AutoGenerateValue = arDefault
    ...
    object qryCRRecebimentoDOC: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DOC'
      Origin = 'DOC'
      ProviderFlags = []
    ...
    object qryCRRecebimentoHISTORICO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'HISTORICO'
      Origin = 'HISTORICO'
      ProviderFlags = []
  ...
  object qryParametro: TFDQuery
    ...
    object qryParametroDATA_ATUALIZACAO: TSQLTimeStampField
      FieldName = 'DATA_ATUALIZACAO'
      Origin = 'DATA_ATUALIZACAO'
    end
    object qryParametroLOGO_ACESSO: TBlobField
      FieldName = 'LOGO_ACESSO'
      Origin = 'LOGO_ACESSO'
    end
    object qryParametroLOGO_CABECALHO: TBlobField
      FieldName = 'LOGO_CABECALHO'
      Origin = 'LOGO_CABECALHO'
    end
    object qryParametroBACKGROUND: TBlobField
      FieldName = 'BACKGROUND'
      Origin = 'BACKGROUND'
    end
    object qryParametroBARRA_SUPERIOR: TStringField
      FieldName = 'BARRA_SUPERIOR'
      Origin = 'BARRA_SUPERIOR'
    end
    object qryParametroBARRA_INFERIOR: TStringField
      FieldName = 'BARRA_INFERIOR'
      Origin = 'BARRA_INFERIOR'
    end
    object qryParametroLOGO_SPLASH: TBlobField
      FieldName = 'LOGO_SPLASH'
      Origin = 'LOGO_SPLASH'
    end
    object qryParametroSPLASH_FUNDO: TStringField
      FieldName = 'SPLASH_FUNDO'
      Origin = 'SPLASH_FUNDO'
    end
    object qryParametroSPLASH_TEXTO: TStringField
      FieldName = 'SPLASH_TEXTO'
      Origin = 'SPLASH_TEXTO'
    end
    object qryParametroSPLASH_LETRA: TStringField
      FieldName = 'SPLASH_LETRA'
      Origin = 'SPLASH_LETRA'
      Size = 100
    end
    object qryParametroSPLASH_ICONE_PRETO: TStringField
      FieldName = 'SPLASH_ICONE_PRETO'
      Origin = 'SPLASH_ICONE_PRETO'
      Size = 1
    end
    object qryParametroMERCADOPAGO_MENSALIDADE_TOKEN: TStringField
      FieldName = 'MERCADOPAGO_MENSALIDADE_TOKEN'
      Origin = 'MERCADOPAGO_MENSALIDADE_TOKEN'
      Size = 100
    end
    object qryParametroTELEGRAM_ID_TOKEN: TStringField
      FieldName = 'TELEGRAM_ID_TOKEN'
      Origin = 'TELEGRAM_ID_TOKEN'
      Size = 100
    end
    object qryParametroTELEGRAM_ID_CHAT: TStringField
      FieldName = 'TELEGRAM_ID_CHAT'
      Origin = 'TELEGRAM_ID_CHAT'
      Size = 100
    end
    object qryParametroNOTIFICACAO_EMAIL_EVENTO: TStringField
      FieldName = 'NOTIFICACAO_EMAIL_EVENTO'
      Origin = 'NOTIFICACAO_EMAIL_EVENTO'
      Size = 100
    end
    object qryParametroPARCEIRO_RAZAO: TStringField
      FieldName = 'PARCEIRO_RAZAO'
      Origin = 'PARCEIRO_RAZAO'
      Size = 50
    end
    object qryParametroPARCEIRO_CNPJ: TStringField
      FieldName = 'PARCEIRO_CNPJ'
      Origin = 'PARCEIRO_CNPJ'
    end
    object qryParametroPARCEIRO_SITE: TStringField
      FieldName = 'PARCEIRO_SITE'
      Origin = 'PARCEIRO_SITE'
      Size = 100
    end
    object qryParametroPARCEIRO_EMAIL: TStringField
      FieldName = 'PARCEIRO_EMAIL'
      Origin = 'PARCEIRO_EMAIL'
      Size = 100
    end
    object qryParametroPARCEIRO_FONE1: TStringField
      FieldName = 'PARCEIRO_FONE1'
      Origin = 'PARCEIRO_FONE1'
      Size = 15
    end
    object qryParametroPARCEIRO_FONE2: TStringField
      FieldName = 'PARCEIRO_FONE2'
      Origin = 'PARCEIRO_FONE2'
      Size = 15
    end
    object qryParametroPARCEIRO_CONTATO: TStringField
      FieldName = 'PARCEIRO_CONTATO'
      Origin = 'PARCEIRO_CONTATO'
      Size = 50
    end
  end
  ...
  object qryTabPreco: TFDQuery
    ...
    object qryTabPrecoTIPO_PRECO: TStringField
      FieldName = 'TIPO_PRECO'
      Origin = 'TIPO_PRECO'
    end
    object qryTabPrecoPERMITE_PRAZO: TStringField
  ...
  object qrySped_H005: TFDQuery
    ...
    object qrySped_H005DATA_INVENTARIO: TDateField
  ...
  object qrySped_H010: TFDQuery
    ...
    object qrySped_H010UND: TStringField
      FieldName = 'UND'
      Origin = 'UND'
    end
  end
  ...
  object QProdAux: TFDQuery
    Connection = Conexao
    SQL.Strings = (
      'Select * from PRODUTO_CODBARRA')
    Left = 864
    Top = 456
    object QProdAuxCOD_PRO: TIntegerField
      FieldName = 'COD_PRO'
      Origin = 'COD_PRO'
    end
    object QProdAuxCOD_BARRA: TStringField
      FieldName = 'COD_BARRA'
      Origin = 'COD_BARRA'
    end
  end
  object qryCountItem: TFDQuery
    Connection = Conexao
    SQL.Strings = (
      'select'
      'sum(i.qtd) as qtd'
  ...
  object qryHistoricoProd: TFDQuery
    AfterPost = qryHistoricoProdAfterPost
    OnNewRecord = qryHistoricoProdNewRecord
    Connection = Conexao
    SQL.Strings = (
      'select * from HISTORICO_PRODUTO')
    Left = 792
    Top = 520
    object qryHistoricoProdCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryHistoricoProdFK_PRODUTO: TIntegerField
      FieldName = 'FK_PRODUTO'
      Origin = 'FK_PRODUTO'
    end
    object qryHistoricoProdFK_EMPRESA: TIntegerField
      FieldName = 'FK_EMPRESA'
      Origin = 'FK_EMPRESA'
    end
    object qryHistoricoProdFK_USUARIO: TIntegerField
      FieldName = 'FK_USUARIO'
      Origin = 'FK_USUARIO'
    end
    object qryHistoricoProdDATA: TDateField
      FieldName = 'DATA'
      Origin = '"DATA"'
    end
    object qryHistoricoProdHORA: TTimeField
      FieldName = 'HORA'
      Origin = 'HORA'
    end
    object qryHistoricoProdORIGEM: TStringField
      FieldName = 'ORIGEM'
      Origin = 'ORIGEM'
      Size = 50
    end
    object qryHistoricoProdQTD_ANTERIOR: TFMTBCDField
      FieldName = 'QTD_ANTERIOR'
      Origin = 'QTD_ANTERIOR'
      Precision = 18
      Size = 6
    end
    object qryHistoricoProdQTD_POSTERIOR: TFMTBCDField
      FieldName = 'QTD_POSTERIOR'
      Origin = 'QTD_POSTERIOR'
      Precision = 18
      Size = 6
    end
    object qryHistoricoProdHISTORICO: TStringField
      FieldName = 'HISTORICO'
      Origin = 'HISTORICO'
      Size = 250
    end
    object qryHistoricoProdQTD_FISCAL_ANTERIOR: TFMTBCDField
      FieldName = 'QTD_FISCAL_ANTERIOR'
      Origin = 'QTD_FISCAL_ANTERIOR'
      Precision = 18
      Size = 4
    end
    object qryHistoricoProdQTD_FISCAL_POSTERIOR: TFMTBCDField
  ...
  object qryPromoSemPro: TFDQuery
    AfterPost = qryPromoSemProAfterPost
    AfterCancel = qryPromoSemProAfterCancel
    BeforeDelete = qryPromoSemProBeforeDelete
    OnNewRecord = qryPromoSemProNewRecord
    Connection = Conexao
    SQL.Strings = (
      'SELECT * FROM PROMO_SEMANA_PRO'
      'WHERE FK_PRODUTO = :PRODUTO')
    Left = 960
    Top = 376
    ParamData = <
      item
    ...
    object qryPromoSemProFK_PRODUTO: TIntegerField
      FieldName = 'FK_PRODUTO'
      Origin = 'FK_PRODUTO'
    end
    object qryPromoSemProDOMINGO: TFMTBCDField
      FieldName = 'DOMINGO'
      Origin = 'DOMINGO'
      DisplayFormat = ',0.00'
      Precision = 18
    ...
    object qryPromoSemProSEGUNDA_FEIRA: TFMTBCDField
      FieldName = 'SEGUNDA_FEIRA'
      Origin = 'SEGUNDA_FEIRA'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object qryPromoSemProTERCA_FEIRA: TFMTBCDField
      FieldName = 'TERCA_FEIRA'
      Origin = 'TERCA_FEIRA'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object qryPromoSemProQUARTA_FEIRA: TFMTBCDField
      FieldName = 'QUARTA_FEIRA'
      Origin = 'QUARTA_FEIRA'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object qryPromoSemProQUINTA_FEIRA: TFMTBCDField
      FieldName = 'QUINTA_FEIRA'
      Origin = 'QUINTA_FEIRA'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object qryPromoSemProSEXTA_FEIRA: TFMTBCDField
      FieldName = 'SEXTA_FEIRA'
      Origin = 'SEXTA_FEIRA'
      DisplayFormat = ',0.00'
      Precision = 18
      Size = 2
    end
    object qryPromoSemProSABADO: TFMTBCDField
      FieldName = 'SABADO'
      Origin = 'SABADO'
      DisplayFormat = ',0.00'
      Precision = 18
  ...
  object qryGEstoqueM: TFDQuery
    Connection = Conexao
    SQL.Strings = (
      'select * from guardaestoque_master')
    Left = 952
    Top = 440
    object qryGEstoqueMMES: TIntegerField
      FieldName = 'MES'
      Origin = 'MES'
    end
    object qryGEstoqueMANO: TIntegerField
      FieldName = 'ANO'
      Origin = 'ANO'
    end
    object qryGEstoqueMDATA: TDateField
      FieldName = 'DATA'
      Origin = '"DATA"'
    end
  end
  object qryTermoGarantia: TFDQuery
    BeforeOpen = qryProdutosBeforeOpen
    Connection = Conexao
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      'select * from TERMO_GARANTIA'
      'where cod_venda = :cod and data_venda between :dat1 and :dat2')
    Left = 1112
    Top = 24
    ParamData = <
      item
    ...
    object qryTermoGarantiaCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryTermoGarantiaCOD_VENDA: TIntegerField
      FieldName = 'COD_VENDA'
      Origin = 'COD_VENDA'
    end
    object qryTermoGarantiaCOD_PROD: TIntegerField
      FieldName = 'COD_PROD'
      Origin = 'COD_PROD'
    end
    object qryTermoGarantiaDATA_VENDA: TDateField
      FieldName = 'DATA_VENDA'
      Origin = 'DATA_VENDA'
    end
    object qryTermoGarantiaHORA_VENDA: TTimeField
      FieldName = 'HORA_VENDA'
      Origin = 'HORA_VENDA'
    end
    object qryTermoGarantiaFK_USUARIO: TIntegerField
      FieldName = 'FK_USUARIO'
      Origin = 'FK_USUARIO'
    end
    object qryTermoGarantiaFK_EMPRESA: TIntegerField
      FieldName = 'FK_EMPRESA'
      Origin = 'FK_EMPRESA'
    end
    object qryTermoGarantiaFK_VEND: TIntegerField
      FieldName = 'FK_VEND'
      Origin = 'FK_VEND'
    end
    object qryTermoGarantiaSTATUS: TStringField
      FieldName = 'STATUS'
      Origin = 'STATUS'
      FixedChar = True
      Size = 1
    end
    object qryTermoGarantiaDATA_VALIDADE: TDateField
      FieldName = 'DATA_VALIDADE'
      Origin = 'DATA_VALIDADE'
    end
    object qryTermoGarantiaVIRTUAL_PRODUTO: TStringField
      FieldKind = fkLookup
      FieldName = 'VIRTUAL_PRODUTO'
    ...
    object qryTermoGarantiaVIRTUAL_VENDEDOR: TStringField
      FieldKind = fkLookup
    ...
    object qryTermoGarantiaVIRTUAL_USUARIO: TStringField
      FieldKind = fkLookup
      FieldName = 'VIRTUAL_USUARIO'
  ...
  object qryRelTermoG: TFDQuery
    BeforeOpen = qryProdutosBeforeOpen
    Connection = Conexao
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      'select t.*, vd.nome, u.login, p.descricao from TERMO_GARANTIA t'
      'inner join vendedores vd on vd.codigo = t.fk_vend'
      'inner join usuarios u on u.codigo = t.fk_usuario'
      'inner join vendas_master vm on vm.codigo = t.cod_venda'
      'inner join produto p on p.codigo = t.cod_prod'
      'where t.cod_venda = :cod')
    Left = 1112
    Top = 72
    ParamData = <
      item
    ...
    object qryRelTermoGCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryRelTermoGCOD_VENDA: TIntegerField
      FieldName = 'COD_VENDA'
      Origin = 'COD_VENDA'
    end
    object qryRelTermoGCOD_PROD: TIntegerField
      FieldName = 'COD_PROD'
      Origin = 'COD_PROD'
    end
    object qryRelTermoGDATA_VENDA: TDateField
      FieldName = 'DATA_VENDA'
      Origin = 'DATA_VENDA'
    end
    object qryRelTermoGHORA_VENDA: TTimeField
      FieldName = 'HORA_VENDA'
      Origin = 'HORA_VENDA'
    end
    object qryRelTermoGFK_USUARIO: TIntegerField
      FieldName = 'FK_USUARIO'
      Origin = 'FK_USUARIO'
    end
    object qryRelTermoGFK_EMPRESA: TIntegerField
      FieldName = 'FK_EMPRESA'
      Origin = 'FK_EMPRESA'
    end
    object qryRelTermoGFK_VEND: TIntegerField
      FieldName = 'FK_VEND'
      Origin = 'FK_VEND'
    end
    object qryRelTermoGSTATUS: TStringField
      FieldName = 'STATUS'
      Origin = 'STATUS'
      FixedChar = True
      Size = 1
    end
    object qryRelTermoGDATA_VALIDADE: TDateField
      FieldName = 'DATA_VALIDADE'
      Origin = 'DATA_VALIDADE'
    end
    object qryRelTermoGNOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'NOME'
      Origin = 'NOME'
      ProviderFlags = []
    ...
    object qryRelTermoGLOGIN: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'LOGIN'
      Origin = 'LOGIN'
      ProviderFlags = []
    ...
    object qryRelTermoGDESCRICAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
  ...
  object QLucroVendaDash: TFDQuery
    AggregatesActive = True
    Connection = Conexao
    SQL.Strings = (
      'select'
    ...
    object QLucroVendaDashT_LIQUIDO: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'T_LIQUIDO'
      Origin = 'T_LIQUIDO'
      ProviderFlags = []
    ...
    object QLucroVendaDashT_BRUTO: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'T_BRUTO'
      Origin = 'T_BRUTO'
      ProviderFlags = []
    ...
    object QLucroVendaDashTOTAL_CUSTO: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QLucroVendaDashLUCRO: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'LUCRO'
      Origin = 'LUCRO'
      ProviderFlags = []
    ...
    object QLucroVendaDashFATG: TAggregateField
      FieldName = 'FATG'
      Visible = True
      Active = True
      DisplayName = ''
    ...
    object QLucroVendaDashLUC: TAggregateField
      FieldName = 'LUC'
      Visible = True
      Active = True
      DisplayName = ''
  ...
  object QryProdutoDash: TFDQuery
    Connection = Conexao
    SQL.Strings = (
      'SELECT First 5 codigo, descricao  FROM produto'
      'where'
      'ativo='#39'S'#39
      'order by codigo desc')
    Left = 520
    ...
    object QryProdutoDashCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QryProdutoDashDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 300
    end
  end
  object qryProdutoMaisVend_dash: TFDQuery
    Connection = Conexao
    SQL.Strings = (
    ...
    object qryProdutoMaisVend_dashID_PRODUTO: TIntegerField
      FieldName = 'ID_PRODUTO'
      Origin = 'ID_PRODUTO'
      Required = True
    end
    object qryProdutoMaisVend_dashDESCRICAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object qryProdutoMaisVend_dashQTD: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'QTD'
      Origin = 'QTD'
      ProviderFlags = []
    ...
    object qryProdutoMaisVend_dashTOTAL: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      ProviderFlags = []
  ...
  object qryItensZerado: TFDQuery
    BeforeOpen = qryProdutosBeforeOpen
    Connection = Conexao
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ...
    object qryItensZeradoCOUNT: TLargeintField
      AutoGenerateValue = arDefault
      FieldName = 'COUNT'
      Origin = '"COUNT"'
      ProviderFlags = []
  ...
  object qryItens: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select dd.*, vd.preco valor_item, vd.vdesconto from devolucao_de' +
        'talhe dd'
      'left join vendas_detalhe vd on vd.codigo=dd.fk_vendas_detalhe'
      'where'
    ...
    object qryItensFK_VENDAS_DETALHE: TIntegerField
      FieldName = 'FK_VENDAS_DETALHE'
      Origin = 'FK_VENDAS_DETALHE'
    end
  ...
  object qrySped_C175: TFDQuery
    Connection = Conexao
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      'select * from sped_c175'
      'where'
      'fk_c100=:id'
      'order by 1')
    Left = 953
    ...
    object qrySped_C175CODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qrySped_C175FK_C100: TIntegerField
      FieldName = 'FK_C100'
      Origin = 'FK_C100'
    end
    object qrySped_C175FK_EMPRESA: TIntegerField
      FieldName = 'FK_EMPRESA'
      Origin = 'FK_EMPRESA'
    end
    object qrySped_C175FK_USUARIO: TIntegerField
      FieldName = 'FK_USUARIO'
      Origin = 'FK_USUARIO'
    end
    object qrySped_C175CFOP: TIntegerField
      FieldName = 'CFOP'
      Origin = 'CFOP'
    end
    object qrySped_C175CST_PIS: TStringField
      FieldName = 'CST_PIS'
      Origin = 'CST_PIS'
      FixedChar = True
      Size = 2
    end
    object qrySped_C175CST_COFINS: TStringField
      FieldName = 'CST_COFINS'
      Origin = 'CST_COFINS'
      FixedChar = True
      Size = 2
    end
    object qrySped_C175ALIQUOTA_PIS: TStringField
      FieldName = 'ALIQUOTA_PIS'
      Origin = 'ALIQUOTA_PIS'
      Size = 3
    end
    object qrySped_C175ALIQUOTA_COFINS: TStringField
      FieldName = 'ALIQUOTA_COFINS'
      Origin = 'ALIQUOTA_COFINS'
      Size = 3
    end
    object qrySped_C175VL_OPR: TFMTBCDField
      FieldName = 'VL_OPR'
      Origin = 'VL_OPR'
      Precision = 18
      Size = 7
    end
    object qrySped_C175BASE_PIS: TFMTBCDField
      FieldName = 'BASE_PIS'
      Origin = 'BASE_PIS'
      Precision = 18
      Size = 7
    end
    object qrySped_C175BASE_COFINS: TFMTBCDField
      FieldName = 'BASE_COFINS'
      Origin = 'BASE_COFINS'
      Precision = 18
      Size = 7
    end
    object qrySped_C175VALOR_PIS: TStringField
      FieldName = 'VALOR_PIS'
      Origin = 'VALOR_PIS'
      Size = 3
    end
    object qrySped_C175VALOR_COFINS: TStringField
      FieldName = 'VALOR_COFINS'
      Origin = 'VALOR_COFINS'
      Size = 3
    end
    object qrySped_C175DESCONTO: TFMTBCDField
      FieldName = 'DESCONTO'
      Origin = 'DESCONTO'
      Precision = 18
      Size = 7
  ...
  object qrySped_H020: TFDQuery
    Connection = Conexao
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      'select pro.csticms, pro.csosn, pro.aliq_icm  from produto pro'
      'where'
      'codigo=:codigo')
    Left = 948
    Top = 101
  ...
  object QryConfigPix: TFDQuery
    Connection = Conexao
    SQL.Strings = (
      'select * from config_pix')
    Left = 408
    Top = 736
    object QryConfigPixNOME_RECEBEDOR: TStringField
      FieldName = 'NOME_RECEBEDOR'
      Origin = 'NOME_RECEBEDOR'
      Size = 200
    end
    object QryConfigPixCEP_RECEBEDOR: TStringField
      FieldName = 'CEP_RECEBEDOR'
      Origin = 'CEP_RECEBEDOR'
      Size = 12
    end
    object QryConfigPixCIDADE_RECEBEDOR: TStringField
      FieldName = 'CIDADE_RECEBEDOR'
      Origin = 'CIDADE_RECEBEDOR'
      Size = 50
    end
    object QryConfigPixAUTENTICAR: TStringField
      FieldName = 'AUTENTICAR'
      Origin = 'AUTENTICAR'
      FixedChar = True
      Size = 1
    end
    object QryConfigPixTOKEN_AUT: TStringField
      FieldName = 'TOKEN_AUT'
      Origin = 'TOKEN_AUT'
      Size = 1000
    end
    object QryConfigPixVALIDADE_TOKEN: TDateField
      FieldName = 'VALIDADE_TOKEN'
      Origin = 'VALIDADE_TOKEN'
    end
    object QryConfigPixPSP: TIntegerField
      FieldName = 'PSP'
      Origin = 'PSP'
    end
    object QryConfigPixAMBIENTE: TIntegerField
      FieldName = 'AMBIENTE'
      Origin = 'AMBIENTE'
    end
    object QryConfigPixTIMEOUT: TIntegerField
      FieldName = 'TIMEOUT'
      Origin = 'TIMEOUT'
    end
    object QryConfigPixHOST: TStringField
      FieldName = 'HOST'
      Origin = 'HOST'
      Size = 100
    end
    object QryConfigPixPORTA: TStringField
      FieldName = 'PORTA'
      Origin = 'PORTA'
      Size = 50
    end
    object QryConfigPixUSER_P: TStringField
      FieldName = 'USER_P'
      Origin = 'USER_P'
      Size = 50
    end
    object QryConfigPixPASS: TStringField
      FieldName = 'PASS'
      Origin = 'PASS'
      Size = 50
    end
    object QryConfigPixCLIENTID_SHI: TStringField
      FieldName = 'CLIENTID_SHI'
      Origin = 'CLIENTID_SHI'
      Size = 500
    end
    object QryConfigPixSECRETID_SHI: TStringField
      FieldName = 'SECRETID_SHI'
      Origin = 'SECRETID_SHI'
      Size = 500
    end
    object QryConfigPixACESSKEY_SHI: TStringField
      FieldName = 'ACESSKEY_SHI'
      Origin = 'ACESSKEY_SHI'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_BB: TStringField
      FieldName = 'CHAVEPIX_BB'
      Origin = 'CHAVEPIX_BB'
      Size = 100
    end
    object QryConfigPixCLIENTID_BB: TStringField
      FieldName = 'CLIENTID_BB'
      Origin = 'CLIENTID_BB'
      Size = 500
    end
    object QryConfigPixCLIENTSECRET_BB: TStringField
      FieldName = 'CLIENTSECRET_BB'
      Origin = 'CLIENTSECRET_BB'
      Size = 500
    end
    object QryConfigPixDEVELOPER_KEY: TStringField
      FieldName = 'DEVELOPER_KEY'
      Origin = 'DEVELOPER_KEY'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_ITAU: TStringField
      FieldName = 'CHAVEPIX_ITAU'
      Origin = 'CHAVEPIX_ITAU'
      Size = 100
    end
    object QryConfigPixCLIENTID_ITAU: TStringField
      FieldName = 'CLIENTID_ITAU'
      Origin = 'CLIENTID_ITAU'
      Size = 500
    end
    object QryConfigPixCLIENTSECRET_ITAU: TStringField
      FieldName = 'CLIENTSECRET_ITAU'
      Origin = 'CLIENTSECRET_ITAU'
      Size = 500
    end
    object QryConfigPixCHAVEPRIVADA_ITAU: TStringField
      FieldName = 'CHAVEPRIVADA_ITAU'
      Origin = 'CHAVEPRIVADA_ITAU'
      Size = 500
    end
    object QryConfigPixARQUIVOCERT_ITAU: TStringField
      FieldName = 'ARQUIVOCERT_ITAU'
      Origin = 'ARQUIVOCERT_ITAU'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_SANT: TStringField
      FieldName = 'CHAVEPIX_SANT'
      Origin = 'CHAVEPIX_SANT'
      Size = 100
    end
    object QryConfigPixCONSUMERKEY_SANT: TStringField
      FieldName = 'CONSUMERKEY_SANT'
      Origin = 'CONSUMERKEY_SANT'
      Size = 500
    end
    object QryConfigPixCONSUMERSECRET_SANT: TStringField
      FieldName = 'CONSUMERSECRET_SANT'
      Origin = 'CONSUMERSECRET_SANT'
      Size = 500
    end
    object QryConfigPixARQCERTPFX_SANT: TStringField
      FieldName = 'ARQCERTPFX_SANT'
      Origin = 'ARQCERTPFX_SANT'
      Size = 500
    end
    object QryConfigPixSENHACERTPX_SANT: TStringField
      FieldName = 'SENHACERTPX_SANT'
      Origin = 'SENHACERTPX_SANT'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_SICR: TStringField
      FieldName = 'CHAVEPIX_SICR'
      Origin = 'CHAVEPIX_SICR'
      Size = 100
    end
    object QryConfigPixCLIENTID_SICR: TStringField
      FieldName = 'CLIENTID_SICR'
      Origin = 'CLIENTID_SICR'
      Size = 500
    end
    object QryConfigPixCLIENTSECRET_SICR: TStringField
      FieldName = 'CLIENTSECRET_SICR'
      Origin = 'CLIENTSECRET_SICR'
      Size = 500
    end
    object QryConfigPixARQCHAVEPRIV_SICR: TStringField
      FieldName = 'ARQCHAVEPRIV_SICR'
      Origin = 'ARQCHAVEPRIV_SICR'
      Size = 500
    end
    object QryConfigPixARQCERT_SICR: TStringField
      FieldName = 'ARQCERT_SICR'
      Origin = 'ARQCERT_SICR'
      Size = 500
    end
    object QryConfigPixCERTCSR_SICR: TStringField
      FieldName = 'CERTCSR_SICR'
      Origin = 'CERTCSR_SICR'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_SICO: TStringField
      FieldName = 'CHAVEPIX_SICO'
      Origin = 'CHAVEPIX_SICO'
      Size = 100
    end
    object QryConfigPixCLIENTID_SICO: TStringField
      FieldName = 'CLIENTID_SICO'
      Origin = 'CLIENTID_SICO'
      Size = 500
    end
    object QryConfigPixARQCHAVEPRI_SICO: TStringField
      FieldName = 'ARQCHAVEPRI_SICO'
      Origin = 'ARQCHAVEPRI_SICO'
      Size = 500
    end
    object QryConfigPixARQCERT_SICO: TStringField
      FieldName = 'ARQCERT_SICO'
      Origin = 'ARQCERT_SICO'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_PAG: TStringField
      FieldName = 'CHAVEPIX_PAG'
      Origin = 'CHAVEPIX_PAG'
      Size = 100
    end
    object QryConfigPixCLIENTID_PAG: TStringField
      FieldName = 'CLIENTID_PAG'
      Origin = 'CLIENTID_PAG'
      Size = 500
    end
    object QryConfigPixCLIENTSECRE_PAG: TStringField
      FieldName = 'CLIENTSECRE_PAG'
      Origin = 'CLIENTSECRE_PAG'
      Size = 500
    end
    object QryConfigPixARQCHAVEPRIV_PAG: TStringField
      FieldName = 'ARQCHAVEPRIV_PAG'
      Origin = 'ARQCHAVEPRIV_PAG'
      Size = 500
    end
    object QryConfigPixARQCERT_PAG: TStringField
      FieldName = 'ARQCERT_PAG'
      Origin = 'ARQCERT_PAG'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_GNET: TStringField
      FieldName = 'CHAVEPIX_GNET'
      Origin = 'CHAVEPIX_GNET'
      Size = 100
    end
    object QryConfigPixCLIENTID_GNET: TStringField
      FieldName = 'CLIENTID_GNET'
      Origin = 'CLIENTID_GNET'
      Size = 500
    end
    object QryConfigPixCLIENTSECR_GNET: TStringField
      FieldName = 'CLIENTSECR_GNET'
      Origin = 'CLIENTSECR_GNET'
      Size = 500
    end
    object QryConfigPixARQPFX: TStringField
      FieldName = 'ARQPFX'
      Origin = 'ARQPFX'
      Size = 500
    end
    object QryConfigPixCHAVEPIX_BR: TStringField
      FieldName = 'CHAVEPIX_BR'
      Origin = 'CHAVEPIX_BR'
      Size = 100
    end
    object QryConfigPixCLIENTID_BR: TStringField
      FieldName = 'CLIENTID_BR'
      Origin = 'CLIENTID_BR'
      Size = 500
    end
    object QryConfigPixCLIENTSECR_BR: TStringField
      FieldName = 'CLIENTSECR_BR'
      Origin = 'CLIENTSECR_BR'
      Size = 500
    end
    object QryConfigPixARQPFX_BR: TStringField
      FieldName = 'ARQPFX_BR'
      Origin = 'ARQPFX_BR'
      Size = 500
    end
    object QryConfigPixSENHAPFX_BR: TStringField
      FieldName = 'SENHAPFX_BR'
      Origin = 'SENHAPFX_BR'
      Size = 500
    end
    object QryConfigPixCNPJ_PIXPDV: TStringField
      FieldName = 'CNPJ_PIXPDV'
      Origin = 'CNPJ_PIXPDV'
      Size = 100
    end
    object QryConfigPixTOKEN_PIXPDV: TStringField
      FieldName = 'TOKEN_PIXPDV'
      Origin = 'TOKEN_PIXPDV'
      Size = 500
    end
    object QryConfigPixSECRECTKEY_PIXPDV: TStringField
      FieldName = 'SECRECTKEY_PIXPDV'
      Origin = 'SECRECTKEY_PIXPDV'
      Size = 500
    end
    object QryConfigPixEXPIRACAO: TIntegerField
      FieldName = 'EXPIRACAO'
      Origin = 'EXPIRACAO'
    end
  end
  ...
  object cdsEncarte: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 8
    Top = 224
    object cdsEncarteCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsEncarteCODBARRA: TStringField
      FieldName = 'CODBARRA'
      Origin = 'CODBARRA'
    end
    object cdsEncartePR_VENDA: TFMTBCDField
      FieldName = 'PR_VENDA'
      Origin = 'PR_VENDA'
      Required = True
      Precision = 18
    ...
    object cdsEncarteDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 100
    end
    object cdsEncartePRECO_ATACADO: TFMTBCDField
      FieldName = 'PRECO_ATACADO'
      Origin = 'PRECO_ATACADO'
      Precision = 18
      Size = 2
    end
    object cdsEncarteREFERENCIA: TStringField
      FieldName = 'REFERENCIA'
      Origin = 'REFERENCIA'
    end
    object cdsEncarteAPLICACAO: TStringField
      FieldName = 'APLICACAO'
      Origin = 'APLICACAO'
      Size = 50
    end
    object cdsEncarteDESC_GRUPO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESC_GRUPO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object cdsEncarteDESC_MARCA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESC_MARCA'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object cdsEncarteUNIDADE: TStringField
      FieldName = 'UNIDADE'
      Origin = 'UNIDADE'
      Required = True
      Size = 3
    end
    object cdsEncarteCOLECAO: TStringField
      FieldName = 'COLECAO'
    end
    object cdsEncarteFOTO: TBlobField
      AutoGenerateValue = arDefault
      FieldName = 'FOTO'
      Origin = 'FOTO'
      Required = True
