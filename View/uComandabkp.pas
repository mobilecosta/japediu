...
type
  TfrmComanda = class(TForm)
    ...
    TabSet1: TTabSet;
    DBGrid1: TDBGridEh;
    qryComandaMESA: TStringField;
    qryComandaNOME: TStringField;
    qryComandaTOTAL: TFMTBCDField;
    qryComandaCODIGO: TIntegerField;
    qryItensCoCODIGO: TIntegerField;
    qryItensCoFK_COMANDA_PESSOA: TIntegerField;
    qryItensCoFK_COMANDA: TIntegerField;
    qryItensCoFK_PRODUTO: TIntegerField;
    qryItensCoPERCENTUAL: TFMTBCDField;
    qryItensCoQTD: TFMTBCDField;
    qryItensCoTOTAL: TFMTBCDField;
    qryItensCoPRECO: TFMTBCDField;
    qryComandaDATA_HORA: TSQLTimeStampField;
