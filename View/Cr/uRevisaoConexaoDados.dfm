object frmRevisaoDadosConexao: TfrmRevisaoDadosConexao
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Revis'#227'o de Dados de Conex'#227'o'
  ClientHeight = 430
  ClientWidth = 413
  Color = clWhite
  ...
  object GroupBox1: TGroupBox
    ...
    object Label7: TLabel
      ...
      Width = 120
      Height = 13
      Caption = 'Razao do Representante'
    end
    ...
    object mercardopago_token: TEdit
      Left = 17
      Top = 284
      Width = 375
      Height = 21
  ...
  object OpenDialog: TOpenDialog
    DefaultExt = '*.fdb'
    Filter = 'Arquivos FDB (*.FDB)|*.FDB|Todos os Arquivos (*.*)|*.*'
