object FrmAtualizacaoFiscal: TFrmAtualizacaoFiscal
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = 'Sistema ERP - Atualiza'#231#227'o Fiscal Produtos'
  ClientHeight = 499
  ClientWidth = 772
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object lblAguarde: TLabel
      ...
      Width = 330
      Height = 19
      Caption = 'Aguarde, execultando processo de atualiza'#231#227'o......'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
    ...
    object dtAtualiza: TDateTimePicker
      Left = 16
      Top = 16
      Width = 105
      Height = 33
      Date = 44979.000000000000000000
      Time = 0.673668518516933500
      TabOrder = 1
    end
    object Button2: TButton
      ...
      Width = 178
      Height = 33
      Caption = 'Efetuar Atualiza'#231#227'o nos Produtos'
      TabOrder = 2
  ...
  object Panel4: TPanel
    ...
    Height = 20
    Align = alTop
    Caption = 'Produdos Troca de Segmentos'
    Color = clWhite
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
  ...
  object DBGrid2: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'idsegmento_anterior'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'ncm_anterior'
        Visible = True
      end
      item
        Expanded = False
  ...
  object dsReponse: TDataSource
    AutoEdit = False
    DataSet = MenResponse
    Left = 610
    Top = 120
  end
  object dsReponse1: TDataSource
    AutoEdit = False
    DataSet = MenResponse1
    Left = 610
    Top = 168
  end
  ...
  object MenResponse1: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ...
    Left = 674
    Top = 280
    object MenResponse1idproduto: TStringField
      FieldName = 'idproduto'
    end
    object MenResponse1idsegmento: TIntegerField
      FieldName = 'idsegmento'
    end
    object MenResponse1ncm: TStringField
      FieldName = 'ncm'
      Size = 10
    end
    object MenResponse1ean: TStringField
      FieldName = 'ean'
    end
    object MenResponse1descricao: TStringField
      FieldName = 'descricao'
      Size = 200
    end
    object MenResponse1idsegmento_anterior: TStringField
      FieldName = 'idsegmento_anterior'
      Size = 10
    end
    object MenResponse1ncm_anterior: TStringField
      FieldName = 'ncm_anterior'
      Size = 10
    end
    object MenResponse1dtatualizacao: TDateTimeField
      FieldName = 'dtatualizacao'
    end
  end
