...
begin
  ...
  BtnEncerrar.Visible := Dados.qryPermissoesBotaoEDITAR.Value = 'S';
...
begin
  if not BtnEncerrar.Visible then
    exit;
...
var
  dia, mes, ano: Word;
begin
  Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - MDFe';
  vOrdem := ' ASC';
...
procedure TfrmConsMDFe.ModuloWhatsApp;
begin
