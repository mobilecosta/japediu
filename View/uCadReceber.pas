...
uses
  ...
  ACBrBase, ACBrEnterTab, Vcl.Samples.Spin, dxSkinsCore,
...
{$R *.dfm}
uses Udados;
procedure TfrmCadReceber.cxGravarClick(Sender: TObject);
begin
   DBEdit2.SetFocus;
...
procedure TfrmCadReceber.cxSairClick(Sender: TObject);
begin
  qryCR.Cancel;
  close;
end;
