object frmParFinanceiroCartao: TfrmParFinanceiroCartao
  Left = 0
  Top = 0
  Caption = 'Par'#226'metros - Financeiro Cart'#227'o'
  ClientHeight = 256
  ClientWidth = 354
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43593.659120243060000000
    ...
    object Compra: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo2: TfrxMemoView
          AllowVectorExport = True
          Left = 5.544960000000000000
          Top = 94.522820000000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIO DE MOVIMENTA'#199#195'O FINANCEIRA - CART'#195'O')
          ParentFont = False
        end
        ...
        object Memo6: TfrxMemoView
          AllowVectorExport = True
          Left = 3.544960000000000000
          Top = 117.143290000000000000
        ...
        object Line4: TfrxLineView
          AllowVectorExport = True
          Left = 0.344960000000000000
          Top = 89.743290000000000000
      ...
      object ColumnHeader1: TfrxColumnHeader
        ...
        object Memo12: TfrxMemoView
          AllowVectorExport = True
          Left = 645.120000000000000000
          Top = 1.600000000000000000
          Width = 100.800000000000000000
          Height = 18.897650000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -13
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object SysMemo3: TfrxSysMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxCartao."ENTRADA">,MasterData1)]')
          ParentFont = False
        end
      end
    end
  ...
  object frxCartao: TfrxDBDataset
    UserName = 'frxCartao'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CODIGO=CODIGO'
  ...
  object qryCartao: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select cr.codigo, cr.dtvencimento as data_credito,  cr.historico' +
        ', cast(cr.valor as float) as entrada from creceber cr'
      'where'
      'cr.data between :data1 and :data2 and'
      'cr.tipo in ('#39'R'#39') AND'
      'CR.valor > 0'
      '/*where*/'
      'order by cR.data')
    Left = 176
    ...
    object qryCartaoDATA_CREDITO: TDateField
    ...
    object qryCartaoENTRADA: TSingleField
      AutoGenerateValue = arDefault
      FieldName = 'ENTRADA'
      Origin = 'ENTRADA'
      ProviderFlags = []
