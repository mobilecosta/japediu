...
uses
  ...
  cxGraphics, cxLookAndFeelPainters, Vcl.Menus, cxButtons, dxSkinsCore,   shellapi,
...
begin
    ...
    form_msg_confirmacao.lbl_texto.Caption   := 'Reinciar o sistema é necessário para aplicar as novas permissões.';
...
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Controle de Permissões';
end;
