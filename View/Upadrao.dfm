object frm_dashboard: Tfrm_dashboard
  ...
  object GroupBox1: TGroupBox
    ...
    object DBEItensZerado: TDBEdit
      Left = 15
      Top = 72
      Width = 120
      Height = 21
      DataField = 'COUNT'
      DataSource = DsItensZerado
      TabOrder = 1
    end
  end
  object GroupBox2: TGroupBox
    ...
    Width = 313
    Height = 121
    Caption = 'Lucratividade Mes Anterior'
    Color = clBtnFace
    ParentBackground = False
    ParentColor = False
    TabOrder = 7
    Visible = False
    object DBEditLucro: TDBEdit
      Left = 7
      Top = 32
      Width = 130
      Height = 21
      DataField = 'LUC'
      DataSource = DsLucratividadeDash
      TabOrder = 0
    end
    ...
    object DBEditFatuGeral: TDBEdit
      Left = 143
      Top = 32
      Width = 130
      Height = 21
  ...
  object DsLucratividadeDash: TDataSource
    DataSet = Dados.QLucroVendaDash
    Left = 192
    Top = 560
  end
  object DataSetProduto: TDataSetProvider
    DataSet = Dados.QryProdutoDash
    Left = 608
    Top = 624
  end
  object ClientDataProduto: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftString
    ...
    ProviderName = 'DataSetProduto'
    Left = 704
    Top = 624
    object ClientDataProdutoCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object ClientDataProdutoDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 300
    end
  end
  object DsItensZerado: TDataSource
    DataSet = Dados.qryItensZerado
    Left = 840
    Top = 248
  end
end
