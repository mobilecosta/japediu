object frmZeraNegativo: TfrmZeraNegativo
  ...
  object qrySaldo: TFDQuery
    ...
    SQL.Strings = (
        ...
        '--SELECT CODIGO,  coalesce(sum(QTDRENTRADA-QTDRSAIDA),0) QTDR FR' +
        'OM('
      ...
      ''
        ...
        'select os.fk_produto as codigo, coalesce(os.qtd,0) qtdrentrada, ' +
        ' coalesce(os.qtd,0) as qtdrsaida'
      'from os_detalhe os'
      'left join produto pro on pro.codigo=os.fk_produto'
      'left join os_master om on om.codigo=os.fk_os_master'
      'where'
      ...
      'where'
      '(vm.situacao<>'#39'C'#39') and (vd.os is null)'
      '/*where*/'
      ''
      'union all'
      ''
      ...
      'where'
        ...
        'not(nfm.situacao in ('#39'3,5,6'#39'))  and nfM.movimento='#39'E'#39' and nfe.ge' +
        'ra_es='#39'S'#39
      '/*where*/'
      ''
      'union all'
      ...
      'where'
        ...
        'not(nfm.situacao in ('#39'3,5,6'#39'))  and nfM.movimento='#39'S'#39' and nfe.ge' +
        'ra_es='#39'S'#39
      '/*where*/'
      ''
      'union all'
      ...
      ''
        ...
        's qtdrentrada, 0 as qtdrsaida'
      ' from devolucao_compra_d DCD'
      'left join produto pro on pro.codigo=DCD.id_produto'
      ...
      ''
        ...
        'select  pro.codigo as codigo, coalesce(pro.qtd_atual, 0) as qtdr' +
        'ENtrada, 0 as qtdrsaida'
      'from produto pro'
      'where pro.qtd_atual < 0'
      ''
      ''
      'union all'
      ''
      
        'select  pro.codigo as codigo, 0 as qtdrENtrada, coalesce(pro.qtd' +
        '_atual, 0) as qtdrsaida'
      'from produto pro'
      'where pro.qtd_atual > 0'
      ''
      'union all'
