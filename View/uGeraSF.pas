  ...
  begin
    ...
    begin
      ...
      if (dtIni.Date <= strtodate('31/12/2021')) then
        COD_VER := vlVersao114;
      if (dtIni.Date <= strtodate('31/12/2022')) then
        COD_VER := vlVersao115;
...
begin
  ...
  begin
    ...
    begin
      ...
      while not Dados.qrySped_C100.Eof do
      begin
//         if  (Dados.qrySped_C100COD_MOD.Value = '59') then
//         begin
//           COD_MOD  := '59' ;
//           if Dados.qrySped_C100cod_sit.Value = '00' then
//           COD_SIT  := COD_SIT.sdRegular;
//           if Dados.qrySped_C100cod_sit.Value = '01' then
//           COD_SIT  := COD_SIT.sdExtempRegular;
//           if Dados.qrySped_C100cod_sit.Value = '02' then
//           COD_SIT  := COD_SIT.sdCancelado;
//           NUM_CFE  := Dados.qrySped_C100CHV_NFE.Value;
//         end;
