...
type
  TfrmBalanca = class(TForm)
    ...
    Referencia: TRadioButton;
    CodigoInterno: TRadioButton;
    CodBarras: TRadioButton;
...
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Balança';
  edtDiretorio.Clear;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if CodigoInterno.Checked = True then
        begin
        Codigo := qryProdutosCODIGO.Value;
        CodBarras.Checked := False;
        Referencia.Checked := False;
        end;
        if CodBarras.Checked = True then
        begin
        Codigo := qryProdutosCODBARRA.AsInteger;
        CodigoInterno.Checked := False;
        Referencia.Checked := False;
        end;
        if Referencia.Checked = True then
        begin
        Codigo := qryProdutosREFERENCIA.AsInteger;
        CodigoInterno.Checked := False;
        CodBarras.Checked := False;
        end;
