...
procedure TfrmCadLaudo.FormCreate(Sender: TObject);
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Lançamento de Laudo';
end;
...
begin
  ...
  if qryLaudo.State = dsInsert then
    qryLaudoCODIGO.Value := Dados.Numerador('LAUDO', 'CODIGO',
      'N', '', '');
