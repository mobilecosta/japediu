...
uses
  ...
  ACBrBarCode, ACBrETQ, ACBrETQClass, dxSkinsCore, dxSkinDevExpressDarkStyle,
...
procedure TfrmConfig.cxGravarClick(Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    Dados.qryParametroVERSAO.Value := 420;
  end
  else
    Dados.qryParametro.Edit;
