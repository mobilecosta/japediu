object frmParCurvaABC: TfrmParCurvaABC
  Left = 0
  Top = 0
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43402.960000358800000000
    ...
    Datasets = <
      item
        DataSet = frmPrincipal.frxDBConferencia
        DataSetName = 'frxDBConferencia'
      end
      item
    ...
    object Compra: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBClientesCODIGO: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBConferencia."CODIGO"]')
          ParentFont = False
        end
        object Memo14: TfrxMemoView
          AllowVectorExport = True
          Left = 187.200000000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBConferencia."DESCRICAO"]')
          ParentFont = False
        end
        object Memo6: TfrxMemoView
          AllowVectorExport = True
          Left = 55.600000000000000000
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'PRODUTOS - CONFER'#202'NCIA DE ESTOQUE')
          ParentFont = False
        end
  ...
  object qryVendas: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select vd.id_produto, pro.descricao, sum(vd.qtd) qtd, sum(vd.tot' +
        'al)total from vendas_detalhe vd'
      'left join produto pro on pro.codigo=vd.id_produto'
      'left join vendas_master vm on vm.codigo=vd.fkvenda'
      'where  '
      'not (vm.situacao in ('#39'A'#39','#39'C'#39')) and'
      '(vm.fkempresa between :emp1 and :emp2) and'
    ...
    object qryVendasCURVA: TStringField
      FieldKind = fkCalculated
      FieldName = 'CURVA'
      Size = 10
      Calculated = True
    end
    object qryVendasTTOTAL: TAggregateField
      FieldName = 'TTOTAL'
      Visible = True
      Active = True
      DisplayName = ''
  ...
  object qryCurva: TFDQuery
    Connection = Dados.Conexao
    SQL.Strings = (
      'select C.*, pro.descricao from CURVA_ABC C'
      'left join produto pro on c.id_produto=pro.codigo'
      'ORDER BY CURVA, TOTAL DESC')
    Left = 328
    Top = 104
    object qryCurvaID_PRODUTO: TIntegerField
      FieldName = 'ID_PRODUTO'
      Origin = 'ID_PRODUTO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryCurvaQTD: TFMTBCDField
      FieldName = 'QTD'
      Origin = 'QTD'
      Precision = 18
      Size = 2
    end
    object qryCurvaTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      Precision = 18
      Size = 2
    end
    object qryCurvaPERCENTUAL: TFMTBCDField
      FieldName = 'PERCENTUAL'
      Origin = 'PERCENTUAL'
      Precision = 18
      Size = 2
    end
    object qryCurvaCURVA: TStringField
      FieldName = 'CURVA'
      Origin = 'CURVA'
      Size = 1
    end
    object qryCurvaFKEMPRESA: TIntegerField
      FieldName = 'FKEMPRESA'
      Origin = 'FKEMPRESA'
    end
    object qryCurvaDESCRICAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
