...
uses
  ...
  Vcl.Menus, cxButtons, dxSkinsCore, dxSkinOffice2019Colorful,
...
begin
  ...
  cxlerXML.Visible := dados.qryPermissoesBotaoEDITAR.Value = 'S';
end;
...
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Compras';
  ...
  cxVisualizar.Caption := 'F8' + sLineBreak + 'Visualizar';
  cxPDF.Caption := 'F9' + sLineBreak + 'Fechar Mês';}
