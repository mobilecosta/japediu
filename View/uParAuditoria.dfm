object FrmParAudi: TFrmParAudi
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsDialog
  Caption = 'Parametros Auditoria '
  ClientHeight = 225
  ClientWidth = 370
  Color = clBtnFace
  ...
  object qryAuditoria: TFDQuery
    ...
    SQL.Strings = (
      'select p.descricao, p.pr_custo, a.* from auditoria_estoque a'
    ...
    object qryAuditoriaCODIGO_PRODUTO: TIntegerField
      FieldName = 'CODIGO_PRODUTO'
      Origin = 'CODIGO_PRODUTO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryAuditoriaCODIGO_BARRA: TStringField
      FieldName = 'CODIGO_BARRA'
      Origin = 'CODIGO_BARRA'
    end
    object qryAuditoriaQTD_ATUAL: TFMTBCDField
      FieldName = 'QTD_ATUAL'
      Origin = 'QTD_ATUAL'
      Precision = 18
      Size = 2
    end
    object qryAuditoriaQTD_ANTERIOR: TFMTBCDField
      FieldName = 'QTD_ANTERIOR'
      Origin = 'QTD_ANTERIOR'
      Precision = 18
      Size = 2
    end
    object qryAuditoriaDIVERGENCIA: TFMTBCDField
      FieldName = 'DIVERGENCIA'
      Origin = 'DIVERGENCIA'
      Precision = 18
      Size = 2
    end
    object qryAuditoriaOPERADOR: TIntegerField
      FieldName = 'OPERADOR'
      Origin = 'OPERADOR'
    end
    object qryAuditoriaDATA_CONFERENCIA: TDateField
      FieldName = 'DATA_CONFERENCIA'
      Origin = 'DATA_CONFERENCIA'
    end
    object qryAuditoriaHORA_CONFERENCIA: TTimeField
      FieldName = 'HORA_CONFERENCIA'
      Origin = 'HORA_CONFERENCIA'
    end
    object qryAuditoriaDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 100
    end
    object qryAuditoriaPR_CUSTO: TFMTBCDField
      FieldName = 'PR_CUSTO'
      Origin = 'PR_CUSTO'
      Required = True
      Precision = 18
  ...
  object frxDBConferencia: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'HORA_CONFERENCIA=HORA_CONFERENCIA'
      'DESCRICAO=DESCRICAO'
      'PR_CUSTO=PR_CUSTO')
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 44491.822090000000000000
    ...
    object Compra: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo22: TfrxMemoView
          ...
          Width = 755.301275200000000000
          Height = 21.180470000000000000
          DataSet = frmPrincipal.frxDBEstoqueNegativoR
          DataSetName = 'frxDBEstoqueNegativoR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          Font.Name = 'Arial'
        ...
        object Memo14: TfrxMemoView
          AllowVectorExport = True
          Left = 116.388930000000000000
          Top = 1.220470000000000000
          Width = 313.095980000000000000
        ...
        object frxDBConferenciaQTD_ATUAL: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object frxDBAuditoriaDIVERGENCIA: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object frxDBSaldoE_S: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
      ...
      object ColumnHeader1: TfrxColumnHeader
        ...
        object Memo7: TfrxMemoView
          AllowVectorExport = True
          Left = 119.727520000000000000
          Top = 4.000000000000000000
          Width = 292.459740000000000000
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object SysMemo3: TfrxSysMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxDBSaldo."QTD_ATUAL">,MasterData1)]')
          ParentFont = False
        end
        ...
        object SysMemo5: TfrxSysMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxDBSaldo."ANT">,MasterData1)]')
          ParentFont = False
        end
        object SysMemo6: TfrxSysMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxDBSaldo."TCUSTO">,MasterData1)]')
          ParentFont = False
        end
      end
      object GroupHeader1: TfrxGroupHeader
        ...
        object frxDBSaldoGRUPO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
  ...
  object qrySaldo: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select distinct(e.fkproduto ), p.descricao, g.descricao as grupo' +
        ', p.qtd_atual as est, e.e_s, p.codbarra, p.pr_custo,'
      '(select a.qtd_a from acerta_estoque a'
      'where a.fkproduto =e.fkproduto and data = '#39'09.10.2021'#39') as ant,'
      ...
      'where p.grupo = :gr and e.data between :da1 and :da2'
    ...
    object qrySaldoFKPRODUTO: TIntegerField
      FieldName = 'FKPRODUTO'
      Origin = 'FKPRODUTO'
    end
    object qrySaldoDESCRICAO: TStringField
    ...
    object qrySaldoE_S: TStringField
      FieldName = 'E_S'
      Origin = 'E_S'
      Size = 1
    end
    object qrySaldoCODBARRA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CODBARRA'
      Origin = 'CODBARRA'
      ProviderFlags = []
    ...
    object qrySaldoANT: TFMTBCDField
      FieldName = 'ANT'
      Origin = 'QTD_A'
      Precision = 18
      Size = 3
    end
    object qrySaldoQTD_ATUAL: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'QTD_ATUAL'
      Origin = 'QTD_ATUAL'
      ProviderFlags = []
    ...
    object qrySaldoPR_CUSTO: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'PR_CUSTO'
      Origin = 'PR_CUSTO'
      ProviderFlags = []
    ...
    object qrySaldoTCUSTO: TFloatField
      FieldKind = fkCalculated
      FieldName = 'TCUSTO'
      Calculated = True
    end
    object qrySaldoGRUPO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'GRUPO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object qrySaldoEST: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'EST'
      Origin = 'QTD_ATUAL'
      ProviderFlags = []
