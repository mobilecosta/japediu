...
uses
  ...
  FireDAC.Comp.Client, ACBrSpedFiscal, Vcl.Imaging.pngimage,
  JvComponentBase, JvEnterTab, JvExControls, JvNavigationPane;
...
procedure TFrmSpedSP.SpeedButton1Click(Sender: TObject);
begin
  close;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Dados.qrySpedrecibo.Value := edtRecibo.Text;
    end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        NUM_REC_ANTERIOR := edtRecibo.Text;
      end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Dados.qrySped_C100.close;
        Dados.qrySped_C100.Params[0].AsInteger := DadosSped.CodSped;
        Dados.qrySped_C100.Open;
        ...
        begin
          ...
          if (Dados.qrySped_C100COD_MOD.Value = '65') then // NFCE
          begin
            with RegistroC100New do
            begin

{$REGION 'C100 NFCe Emitida'}
...
{$ENDREGION}
              Dados.qrySped_C175.close;
              Dados.qrySped_C175.Params[0].Value :=
                Dados.qrySped_C100CODIGO.Value;
              Dados.qrySped_C175.Open;

              FormatSettings.DecimalSeparator := ',';

              codigo := 1;
{$REGION 'C175 NFE Emitida/Terceiros'}
              while not Dados.qrySped_C175.Eof do
              begin
                with RegistroC175New do // Inicio Adicionar os Itens:
                begin
                  CFOP := Dados.qrySped_C175CFOP.AsString;
                  VL_OPR := Dados.qrySped_C175VL_OPR.AsFloat;
                  VL_DESC := Dados.qrySped_C175DESCONTO.AsFloat;
                  VL_BC_PIS := Dados.qrySped_C175BASE_PIS.AsFloat;
                  VL_PIS := Dados.qrySped_C175VALOR_PIS.AsFloat;
                  ALIQ_PIS := Dados.qrySped_C175ALIQUOTA_PIS.AsFloat;
                  QUANT_BC_PIS := 0;
                  ALIQ_PIS_QUANT := 0;
                  VL_BC_COFINS := Dados.qrySped_C175BASE_COFINS.AsFloat;
                  VL_COFINS := Dados.qrySped_C175VALOR_COFINS.AsFloat;
                  ALIQ_COFINS := Dados.qrySped_C175ALIQUOTA_PIS.AsFloat;
                  QUANT_BC_COFINS := 0;
                  ALIQ_COFINS_QUANT := 0;

                  if Dados.qrySped_C175CST_PIS.Value = '01' then
                    CST_PIS := cstpis01;

                  if Dados.qrySped_C175CST_PIS.Value = '02' then
                    CST_PIS := cstpis02;

                  if Dados.qrySped_C175CST_PIS.Value = '03' then
                    CST_PIS := cstpis03;

                  if Dados.qrySped_C175CST_PIS.Value = '04' then
                    CST_PIS := cstpis04;

                  if Dados.qrySped_C175CST_PIS.Value = '05' then
                    CST_PIS := cstpis05;

                  if Dados.qrySped_C175CST_PIS.Value = '06' then
                    CST_PIS := cstpis06;

                  if Dados.qrySped_C175CST_PIS.Value = '07' then
                    CST_PIS := cstpis07;

                  if Dados.qrySped_C175CST_PIS.Value = '08' then
                    CST_PIS := cstpis08;

                  if Dados.qrySped_C175CST_PIS.Value = '09' then
                    CST_PIS := cstpis09;

                  if Dados.qrySped_C175CST_PIS.Value = '49' then
                    CST_PIS := cstpis49;

                  if Dados.qrySped_C175CST_PIS.Value = '50' then
                    CST_PIS := cstpis50;

                  if Dados.qrySped_C175CST_PIS.Value = '51' then
                    CST_PIS := cstpis51;

                  if Dados.qrySped_C175CST_PIS.Value = '52' then
                    CST_PIS := cstpis52;

                  if Dados.qrySped_C175CST_PIS.Value = '53' then
                    CST_PIS := cstpis53;

                  if Dados.qrySped_C175CST_PIS.Value = '54' then
                    CST_PIS := cstpis54;

                  if Dados.qrySped_C175CST_PIS.Value = '55' then
                    CST_PIS := cstpis55;

                  if Dados.qrySped_C175CST_PIS.Value = '56' then
                    CST_PIS := cstpis56;

                  if Dados.qrySped_C175CST_PIS.Value = '60' then
                    CST_PIS := cstpis60;

                  if Dados.qrySped_C175CST_PIS.Value = '61' then
                    CST_PIS := cstpis61;

                  if Dados.qrySped_C175CST_PIS.Value = '62' then
                    CST_PIS := cstpis62;

                  if Dados.qrySped_C175CST_PIS.Value = '63' then
                    CST_PIS := cstpis63;

                  if Dados.qrySped_C175CST_PIS.Value = '64' then
                    CST_PIS := cstpis64;

                  if Dados.qrySped_C175CST_PIS.Value = '65' then
                    CST_PIS := cstpis65;

                  if Dados.qrySped_C175CST_PIS.Value = '66' then
                    CST_PIS := cstpis66;

                  if Dados.qrySped_C175CST_PIS.Value = '67' then
                    CST_PIS := cstpis67;

                  if Dados.qrySped_C175CST_PIS.Value = '70' then
                    CST_PIS := cstpis70;

                  if Dados.qrySped_C175CST_PIS.Value = '71' then
                    CST_PIS := cstpis71;

                  if Dados.qrySped_C175CST_PIS.Value = '72' then
                    CST_PIS := cstpis72;

                  if Dados.qrySped_C175CST_PIS.Value = '73' then
                    CST_PIS := cstpis73;

                  if Dados.qrySped_C175CST_PIS.Value = '74' then
                    CST_PIS := cstpis74;

                  if Dados.qrySped_C175CST_PIS.Value = '75' then
                    CST_PIS := cstpis75;

                  if Dados.qrySped_C175CST_PIS.Value = '98' then
                    CST_PIS := cstpis98;

                  if Dados.qrySped_C175CST_PIS.Value = '99' then
                    CST_PIS := cstpis99;

                  if Dados.qrySped_C175CST_COFINS.Value = '01' then
                    CST_COFINS := cstCOFINS01;

                  if Dados.qrySped_C175CST_COFINS.Value = '02' then
                    CST_COFINS := cstCOFINS02;

                  if Dados.qrySped_C175CST_COFINS.Value = '03' then
                    CST_COFINS := cstCOFINS03;

                  if Dados.qrySped_C175CST_COFINS.Value = '04' then
                    CST_COFINS := cstCOFINS04;

                  if Dados.qrySped_C175CST_COFINS.Value = '05' then
                    CST_COFINS := cstCOFINS05;

                  if Dados.qrySped_C175CST_COFINS.Value = '06' then
                    CST_COFINS := cstCOFINS06;

                  if Dados.qrySped_C175CST_COFINS.Value = '07' then
                    CST_COFINS := cstCOFINS07;

                  if Dados.qrySped_C175CST_COFINS.Value = '08' then
                    CST_COFINS := cstCOFINS08;

                  if Dados.qrySped_C175CST_COFINS.Value = '09' then
                    CST_COFINS := cstCOFINS09;

                  if Dados.qrySped_C175CST_COFINS.Value = '49' then
                    CST_COFINS := cstCOFINS49;

                  if Dados.qrySped_C175CST_COFINS.Value = '50' then
                    CST_COFINS := cstCOFINS50;

                  if Dados.qrySped_C175CST_COFINS.Value = '51' then
                    CST_COFINS := cstCOFINS51;

                  if Dados.qrySped_C175CST_COFINS.Value = '52' then
                    CST_COFINS := cstCOFINS52;

                  if Dados.qrySped_C175CST_COFINS.Value = '53' then
                    CST_COFINS := cstCOFINS53;

                  if Dados.qrySped_C175CST_COFINS.Value = '54' then
                    CST_COFINS := cstCOFINS54;

                  if Dados.qrySped_C175CST_COFINS.Value = '55' then
                    CST_COFINS := cstCOFINS55;

                  if Dados.qrySped_C175CST_COFINS.Value = '56' then
                    CST_COFINS := cstCOFINS56;

                  if Dados.qrySped_C175CST_COFINS.Value = '60' then
                    CST_COFINS := cstCOFINS60;

                  if Dados.qrySped_C175CST_COFINS.Value = '61' then
                    CST_COFINS := cstCOFINS61;

                  if Dados.qrySped_C175CST_COFINS.Value = '62' then
                    CST_COFINS := cstCOFINS62;

                  if Dados.qrySped_C175CST_COFINS.Value = '63' then
                    CST_COFINS := cstCOFINS63;

                  if Dados.qrySped_C175CST_COFINS.Value = '64' then
                    CST_COFINS := cstCOFINS64;

                  if Dados.qrySped_C175CST_COFINS.Value = '65' then
                    CST_COFINS := cstCOFINS65;

                  if Dados.qrySped_C175CST_COFINS.Value = '66' then
                    CST_COFINS := cstCOFINS66;

                  if Dados.qrySped_C175CST_COFINS.Value = '67' then
                    CST_COFINS := cstCOFINS67;

                  if Dados.qrySped_C175CST_COFINS.Value = '70' then
                    CST_COFINS := cstCOFINS70;

                  if Dados.qrySped_C175CST_COFINS.Value = '71' then
                    CST_COFINS := cstCOFINS71;

                  if Dados.qrySped_C175CST_COFINS.Value = '72' then
                    CST_COFINS := cstCOFINS72;

                  if Dados.qrySped_C175CST_COFINS.Value = '73' then
                    CST_COFINS := cstCOFINS73;

                  if Dados.qrySped_C175CST_COFINS.Value = '74' then
                    CST_COFINS := cstCOFINS74;

                  if Dados.qrySped_C175CST_COFINS.Value = '75' then
                    CST_COFINS := cstCOFINS75;

                  if Dados.qrySped_C175CST_COFINS.Value = '98' then
                    CST_COFINS := cstCOFINS98;

                  if Dados.qrySped_C175CST_COFINS.Value = '99' then
                ...
                Dados.qrySped_C175.Next;
              end; // fim do while c175
{$ENDREGION}
            end;
          ...
          if (Dados.qrySped_C100COD_MOD.Value = '55') then // NFE
          begin
            with RegistroC100New do
            begin

{$REGION 'C100 NFe Emitida'}
...
{$ENDREGION}
{$REGION 'C100 NFe Terceiros/Compras'}
...
{$ENDREGION}
              ...
              codigo := 1;
{$REGION 'C170 NFE Emitida/Terceiros'}
