object FrmProdutosVencidos: TFrmProdutosVencidos
  Left = 0
  Top = 0
  ...
  object qryRel: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select p.codbarra,p.qtd_atual, p.descricao, p.dt_validade, g.des' +
        'cricao as grupo_sl from produto p'
      'inner join grupo g on g.codigo = p.grupo'
      
        'where p.qtd_atual > 0 and p.grupo between :gp and :gp1  and p.dt' +
        '_validade  between  :dat1 and :dat2'
    ...
    object qryRelDT_VALIDADE: TDateField
      FieldName = 'DT_VALIDADE'
      Origin = 'DT_VALIDADE'
    end
    object qryRelGRUPO_SL: TStringField
    ...
    object qryRelQTD_ATUAL: TFMTBCDField
      FieldName = 'QTD_ATUAL'
      Origin = 'QTD_ATUAL'
      Required = True
      Precision = 18
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 44556.618366909720000000
    ...
    object Compra: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 755.301275200000000000
        Condition = 'frxDBRelVenc."GRUPO_SL"'
