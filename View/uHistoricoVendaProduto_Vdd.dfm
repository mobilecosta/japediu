object frmHistoricoVendaProduto_VDD: TfrmHistoricoVendaProduto_VDD
  Left = 0
  Top = 0
  BorderStyle = bsSingle
  Caption = 'Hist'#243'rico de Vendas de Produtos p/ Vendedor'
  ClientHeight = 365
  ClientWidth = 572
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43965.434715370370000000
    ...
    object Compra: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo8: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIO DE VENDAS DE PRODUTOS P/ VENDEDOR - DETALHADO')
          ParentFont = False
        end
        object Memo21: TfrxMemoView
          AllowVectorExport = True
          Left = 342.582870000000000000
  ...
  object qryHistorico: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select pe.codigo as idpessoa, pe.razao, ve.nome, VM.data_emissao' +
        ' data,  vd.fkvenda as numero,  vd.id_produto as codigo, pro.refe' +
        'rencia, pro.descricao, gr.descricao as grupo, coalesce(vd.qtd,0)' +
      ...
      've.codigo like :vendedor  and'
      'pro.codigo like :produto'
      'order by ve.nome, vm.data_emissao, vd.id_produto'
      '')
    Left = 240
    Top = 81
    ParamData = <
    ...
    object qryHistoricoNOME: TStringField
      FieldName = 'NOME'
      Origin = 'NOME'
      Size = 40
    end
  ...
  object qryHistoricoR: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select ve.nome,  pe.codigo as idpessoa, pe.razao, vd.id_produto ' +
        'as codigo,pro.descricao, gr.descricao as grupo, SUM(coalesce(vd.' +
        'qtd,0)) qtd, SUM(vd.total)total   from vendas_detalhe vd'
      'left join produto pro on pro.codigo=vd.id_produto'
      'left join vendas_master vm on vm.codigo=vd.fkvenda'
      'left join pessoa pe on pe.codigo=vm.id_cliente'
      'left join vendedores ve on ve.codigo=vm.fk_vendedor'
    ...
    object qryHistoricoRNOME: TStringField
      FieldName = 'NOME'
      Origin = 'NOME'
      Size = 40
    end
  ...
  object qryVendedor: TFDQuery
    ...
    SQL.Strings = (
      ...
      'SELECT ve.codigo, ve.nome FROM vendedores ve'
        ...
        'UNION SELECT (0) AS CODIGO, ('#39'   <Todos os Vendedores>'#39') AS NOME' +
        ' from RDB$DataBase'
      ')'
      'order by trim(NOME)'
      '')
  ...
  object Comissao: TFDMemTable
    ...
    Left = 376
    Top = 300
    object ComissaoCOMISSAO_P: TFloatField
      FieldName = 'COMISSAO_P'
    end
    object ComissaoCOMISSAO_V: TFloatField
      FieldName = 'COMISSAO_V'
    end
  end
  object qryHistoricoT: TFDQuery
    Connection = Dados.Conexao
    SQL.Strings = (
      'select'
      'distinct(vd.nome) as vendedor,'
      'fp.descricao as forma,'
      'sum(vf.valor - vf.troco) as valor_pago'
      'from vendas_fpg vf'
      'inner join vendas_master v on vf.vendas_master = v.codigo'
      'inner join vendedores vd on vd.codigo = v.fk_vendedor'
      'inner join forma_pagamento fp on fp.codigo = vf.id_forma'
      'where v.situacao in ('#39'F'#39') and'
      'v.situacao<> '#39'C'#39' and'
      'V.data_emissao BETWEEN :DATA1 AND :DATA2 AND'
      'vd.codigo like :vendedor   '
      'group by 1,2'
      'order by 1')
    Left = 120
    Top = 137
    ...
    object qryHistoricoTVENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      Origin = 'VENDEDOR'
      Size = 40
    end
    object qryHistoricoTFORMA: TStringField
      FieldName = 'FORMA'
      Origin = 'FORMA'
      Size = 30
    end
    object qryHistoricoTVALOR_PAGO: TFMTBCDField
      FieldName = 'VALOR_PAGO'
      Origin = 'VALOR_PAGO'
      Precision = 18
      Size = 2
    end
    object qryHistoricoTCOMISSAO_P: TFloatField
      FieldKind = fkCalculated
      FieldName = 'COMISSAO_P'
      Calculated = True
    end
    object qryHistoricoTCOMISSAO_V: TFloatField
      FieldKind = fkCalculated
      FieldName = 'COMISSAO_V'
      Calculated = True
    end
  end
  object frxDBHistoricoT: TfrxDBDataset
    UserName = 'frxDBHistoricoT'
    CloseDataSource = False
    FieldAliases.Strings = (
      'VENDEDOR=VENDEDOR'
      'FORMA=FORMA'
      'VALOR_PAGO=VALOR_PAGO')
    DataSet = qryHistoricoT
    BCDToCurrency = False
    DataSetOptions = []
    Left = 175
    Top = 163
