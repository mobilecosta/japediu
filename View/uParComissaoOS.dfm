object FrmComissaoOS: TFrmComissaoOS
  Left = 0
  Top = 0
  ...
  object qryVendedor: TFDQuery
    ...
    SQL.Strings = (
      ...
      'FROM(SELECT codigo,'
      '            fantasia as nome'
      '     FROM pessoa where tecnico = '#39'S'#39
      '     UNION'
      '     SELECT (0) AS CODIGO,'
      '            ('#39'<todos os tecnicos>'#39') AS NOME'
      '     from RDB$DataBase'
      ')'
      'order by NOME')
    Left = 256
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43992.381039421300000000
    ...
    object Compra: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'COMISS'#195'O DE TECNICOS DETALHE')
          ParentFont = False
        end
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frxDBDetalhado'
        RowCount = 0
        object frxDBDetalhadoDESCRICAO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDetalhado."CODIGO"] - [frxDBDetalhado."DESCRICAO"]')
          ParentFont = False
        end
        object frxDBDetalhadoPERC_COMISSAO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object frxDBDetalhadoVALOR_COMISSAO1: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object Memo17: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'Recebimento: [frxDBDetalhado."DESRECEBIMENTO"]')
          ParentFont = False
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        object frxDBDetalhadoNOME: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'TECNICO: [frxDBDetalhado."NOME"]')
        end
        object frxDBDetalhadoNUMERO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
        ...
        object frxDBDetalhadoDATA_EMISSAO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 69.063080000000000000
          Top = 1.000000000000000000
          Width = 64.252010000000000000
          Height = 17.007874020000000000
          DataSet = frxDBDetalhado
  ...
  object qryDetalhado: TFDQuery
    ...
    SQL.Strings = (
      ...
      '       a.preco,'
      '       a.total,'
      '       a.percomissao as perc_comissao,'
      '       a.valcomissao as valor_comissao,'
      '       a.fk_os_master,'
      
        '       '#39'Veiculo: '#39'||coalesce(vei.desc_veiculo,'#39#39')||'#39' Placa: '#39'||c' +
        'oalesce(b.placa,'#39#39')||'#39' Cliente: '#39'||coalesce(d.razao,'#39#39') as obser' +
        'vacao_os,'
      
        '       (select cast(list(trim(tprecebimento)||'#39' '#39'||trim(qtdreceb' +
        'imento)||'#39'x Vr.'#39'||valrecebimento, '#39', '#39') as varchar(255)) as rece' +
        'bimento'
      '        from ('
      '        select case bb.tipo'
      '                 when '#39'D'#39' then '#39'DINHEIRO'#39
      '                 when '#39'Q'#39' then '#39'CHEQUE'#39
      '                 when '#39'F'#39' then '#39'CREDITO LOJA'#39
      '                 when '#39'X'#39' then '#39'DEPOSITO'#39
      '                 when '#39'C'#39' then '#39'CARTAO DE CREDITO'#39
      '                 when '#39'E'#39' then '#39'CARTAO DE DEBITO'#39
      '                 when '#39'B'#39' then '#39'BOLETO BANCARIO'#39
      '                 when '#39'R'#39' then '#39'VALE REFEICAO'#39
      '                 when '#39'O'#39' then '#39'VALE COMBUSTIVEL'#39
      '                 when '#39'P'#39' then '#39'VALE PRESENTE'#39
      '                 when '#39'V'#39' then '#39'CONVENIO'#39
      '                 when '#39'T'#39' then '#39'OUTROS'#39
      '               end as tprecebimento,'
      '               count(aa.fk_forma_pag) as qtdrecebimento,'
      '               sum(aa.valrecebimento) as valrecebimento'
      '        from os_recebimento aa'
      
        '             inner join forma_pagamento bb on(bb.codigo = aa.fk_' +
        'forma_pag)'
      '        where aa.fk_os_master = a.fk_os_master'
      '        group by tprecebimento)) as desrecebimento'
      'from os_detalhe a'
      '     left join os_master b on b.codigo = a.fk_os_master'
      '     left join pessoa c on c.codigo = a.fk_funcionario'
      '     left join pessoa d on d.codigo = b.fk_cliente'
      '     left join produto pro on pro.codigo = a.fk_produto'
      
        '     left join pessoa_veiculos vei on vei.placa_veiculo = b.plac' +
        'a'
      'where (b.data_emissao between :data1 and :data2)'
      '  and (b.situacao = '#39'F'#39')'
      '  and (c.codigo > 0)'
      '/*where*/'
      'order by 1,2,3,4')
    Left = 328
    ...
    object qryDetalhadoCODTECNICO: TIntegerField
      FieldName = 'CODTECNICO'
      Origin = 'CODTECNICO'
    end
    object qryDetalhadofk_os_master: TIntegerField
      FieldName = 'fk_os_master'
    end
    object qryDetalhadoDESRECEBIMENTO: TStringField
      FieldName = 'DESRECEBIMENTO'
      Origin = 'DESRECEBIMENTO'
      Size = 255
    end
    object qryDetalhadoobservacao_os: TStringField
      FieldName = 'observacao_os'
      Size = 287
    end
  end
  ...
  object frxReportResumo: TfrxReport
    Version = '6.6.17'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 41869.389758275500000000
    ReportOptions.LastChange = 43978.101844386600000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      'end.')
    ...
    object Compra: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'COMISS'#195'O DE TECNICOS RESUMO')
          ParentFont = False
        end
        object frxDBEmpresaENDERECO: TfrxMemoView
          AllowVectorExport = True
