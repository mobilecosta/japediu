...
begin
  ...
  DBGrid1.Columns[3].Title.Caption := 'Historico';
  DBGrid1.Columns[4].Title.Caption := 'Doc';
...
procedure TfrmConsPagar.Botoes;
begin
  btnNovo.Visible := Dados.qryPermissoesBotaoINCLUIR.Value = 'S';
  btnAlterar.Visible := Dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnEstornar.Visible := Dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnEstornar.Visible := Dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnBaixar.Visible := Dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnBaixaLote.Visible := Dados.qryPermissoesBotaoEDITAR.Value = 'S';
end;

procedure TfrmConsPagar.FormCreate(Sender: TObject);
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Contas Pagar';
  Dados.aMenu := 'MnCP';
  vOrdem := ' ASC';
