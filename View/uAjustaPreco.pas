...
procedure TFrmAjustaPreco.Botoes;
begin
  DBGrid1.ReadOnly := not(dados.qryPermissoesBotaoEDITAR.Value = 'S');
end;

procedure TFrmAjustaPreco.FormCreate(Sender: TObject);
begin
  Caption := dados.qryParametroTITULO_SISTEMA.Value + ' - Ajusta Preço';
