    ...
    begin
      ...
      begin
        ...
        begin
          dados.qryConsulta.Close;
          dados.qryConsulta.SQL.Text :=
            ' select pr.codigo, pr.codbarra, pr.unidade, pr.cfop,  pr.ncm, pr.EFISCAL, pr.qtd_atual from produto pr '
            + ' where ' + ' pr.codigo=:id ';
          dados.qryConsulta.Params[0].Value := qryPV_ItensID_PRODUTO.AsInteger;
          dados.qryConsulta.Open;
          if dados.qryConsulta.FieldByName('EFISCAL').AsString = 'S' then
          begin
