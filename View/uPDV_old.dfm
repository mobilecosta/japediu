object FrmPDV: TFrmPDV
  ...
  object dxNavBarPdv: TdxNavBar
    ...
    object Dev_Venda: TdxNavBarGroup
      ...
      UseSmallImages = False
      OptionsExpansion.Expanded = False
      OnClick = Dev_VendaClick
      Links = <>
      ParentGroupIndex = -1
      Position = 10
    end
    object Gerenciamento_nfce: TdxNavBarGroup
      Caption = 'Gerenciamento NFCe'
      LargeImageIndex = 28
      SelectedLinkIndex = -1
      TopVisibleLinkIndex = 0
      UseSmallImages = False
      OptionsExpansion.Expanded = False
      OnClick = Gerenciamento_nfceClick
      Links = <>
      ParentGroupIndex = -1
      Position = 11
    end
