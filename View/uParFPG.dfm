object frmParFPG: TfrmParFPG
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Par'#226'metros - Vendas por Forma de Pgto'
  ClientHeight = 299
  ClientWidth = 384
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 44108.401751944400000000
    ...
    object Compra: TfrxReportPage
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object SysMemo2: TfrxSysMemoView
          AllowVectorExport = True
          Left = 662.360420000000000000
          Top = 0.820470000000114000
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIO DE VENDAS POR FORMA DE PAGAMENTO')
          ParentFont = False
        end
        object frxDBEmpresaENDERECO: TfrxMemoView
          AllowVectorExport = True
          Left = 120.944960000000000000
          Top = 42.743290000000000000
        ...
        object Picture1: TfrxPictureView
          AllowVectorExport = True
          Left = 15.544960000000000000
          Top = 6.343290000000000000
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frxDBFPG'
        RowCount = 0
        object frxDBFPGDESCRICAO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 11.118120000000000000
          Top = 0.779530000000023000
          Width = 302.582870000000000000
          Height = 18.897650000000000000
          DataField = 'DESCRICAO'
          DataSet = frxDBFPG
          DataSetName = 'frxDBFPG'
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object SysMemo3: TfrxSysMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxDBFPG."VALOR">,MasterData1)]')
          ParentFont = False
        end
      end
    end
  ...
  object qryDiario: TFDQuery
    ...
    SQL.Strings = (
      ...
      'where'
        ...
        'nd vf.total>0 --and vf.tipo<>'#39'T'#39
      '/*where*/'
      'group by 1'
      'order by 1')
    Left = 176
  ...
  object qryDiarioD: TFDQuery
    ...
    SQL.Strings = (
        ...
        's caixa, usu.login, '
      ' vf.total as valor from vendas_fpg vf'
      ' left join forma_pagamento fpg on fpg.codigo=vf.id_forma'
      ' left join vendas_master vm on vm.codigo=vf.vendas_master'
      ...
      ' where'
        ...
        ' vf.situacao='#39'F'#39' and vm.data_emissao between :data1 and :data2  ' +
        'and vf.total>0 --and vf.tipo<>'#39'T'#39
      ' /*where*/'
  ...
  object qryDiarioDMas: TFDQuery
    AggregatesActive = True
    Connection = Dados.Conexao
    SQL.Strings = (
      'select'
      '/*informacoes da venda*/'
      'pe.razao cliente, ve.nome vendedor,'
      
        'fpg.descricao, vm.codigo, vm.data_emissao, co.descricao as caixa' +
        ', usu.login, vf.total as valor'
      'from vendas_fpg vf'
      ' left join forma_pagamento fpg on fpg.codigo=vf.id_forma'
      ' left join vendas_master vm on vm.codigo=vf.vendas_master'
      ' left join usuarios usu on usu.codigo=vm.fk_usuario'
    ...
    object qryDiarioDMasCLIENTE: TStringField
      FieldName = 'CLIENTE'
      Origin = 'CLIENTE'
      Size = 100
    end
    object qryDiarioDMasVENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      Origin = 'VENDEDOR'
      Size = 40
    end
    object qryDiarioDMasDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 30
    end
    object qryDiarioDMasCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object qryDiarioDMasDATA_EMISSAO: TDateField
      FieldName = 'DATA_EMISSAO'
      Origin = 'DATA_EMISSAO'
    end
    object qryDiarioDMasCAIXA: TStringField
      FieldName = 'CAIXA'
      Origin = 'CAIXA'
      Size = 40
    end
    object qryDiarioDMasLOGIN: TStringField
      FieldName = 'LOGIN'
      Origin = 'LOGIN'
      Size = 50
    end
    object qryDiarioDMasVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      Precision = 18
      Size = 4
  ...
  object dsDiarioMas: TDataSource
    DataSet = qryDiarioDMas
    Left = 336
    Top = 24
  end
  object qryItensVenda: TFDQuery
    MasterSource = dsDiarioMas
    MasterFields = 'CODIGO'
    Connection = Dados.Conexao
    SQL.Strings = (
  ...
  object frxDBFPGDMas: TfrxDBDataset
    UserName = 'frxDBFPGDMas'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CLIENTE=CLIENTE'
      'VENDEDOR=VENDEDOR'
  ...
  object qryFPG: TFDQuery
    Connection = Dados.Conexao
    SQL.Strings = (
      'SELECT CODIGO, DESCRICAO, ATIVO FROM('
      'SELECT codigo, descricao, ativo FROM FORMA_PAGAMENTO'
      
        'UNION SELECT (0) AS CODIGO, ('#39'<Todas as formas de pagamento>'#39') A' +
        'S DESCRICAO, '#39'S'#39' ATIVO  from RDB$DataBase'
      ')'
      'where ATIVO='#39'S'#39
      'order by DESCRICAO')
    Left = 176
