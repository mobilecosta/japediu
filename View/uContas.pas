...
begin
  Caption := dados.qryParametroTITULO_SISTEMA.Value + ' - Contas';
...
procedure TfrmContas.btnLiberarClick(Sender: TObject);
begin
  if Application.messageBox('Tem certeza de que deseja liberar caixa?',
  ...
  dados.qryContas.edit;
  dados.qryContasSITUACAO.Value := 'F';
  dados.qryContasID_USUARIO.Clear;
  dados.qryContasDATA_ABERTURA.Clear;
  dados.qryContas.Post;
end;
