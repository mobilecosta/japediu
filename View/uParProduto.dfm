object frmParProduto: TfrmParProduto
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43402.958637881940000000
  ...
  object qryLucro: TFDQuery
    ...
    SQL.Strings = (
        ...
        'ndas-custo) lucro from('
      
        'select vd.id_produto, pro.descricao, sum(qtd) qtd, (max(pro.pr_c' +
        'usto)*SUM(vd.qtd)) CUSTO,  (sum(VD.QTD)*avg(vd.preco)) vendas fr' +
        'om vendas_detalhe vd'
      'left join produto pro on pro.codigo=vd.id_produto'
