object frmParBalanco: TfrmParBalanco
  Left = 0
  Top = 0
  Caption = 'Par'#226'metros - Balan'#231'o Financeiro'
  ClientHeight = 214
  ClientWidth = 375
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43339.948551863420000000
    ...
    object Compra: TfrxReportPage
      ...
      object Totais: TfrxReportSummary
        ...
        object SysMemo4: TfrxSysMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<frxDBBalanco."ENTRADA">,MasterData1)-SUM(<frxDBBalanco."SA' +
              'IDA">,MasterData1)]')
          ParentFont = False
        end
      end
      object MasterData1: TfrxMasterData
        ...
        object Memo5: TfrxMemoView
          ...
          Width = 755.906000000000000000
          Height = 24.000000000000000000
          DataSet = FrmParametros.frxDBCompra
        ...
        object Memo15: TfrxMemoView
          AllowVectorExport = True
          Left = 100.535433070866000000
          Top = 2.879999999999996000
          Width = 480.377952755906000000
          Height = 17.280000000000000000
          DataField = 'NOME'
          DataSet = frxDBBalanco
          DataSetName = 'frxDBBalanco'
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        object frxDBBalancoCONTA: TfrxMemoView
          AllowVectorExport = True
        ...
        object Memo14: TfrxMemoView
          AllowVectorExport = True
          Left = 100.655433070000000000
          Top = 24.677180000000050000
          Width = 480.377952760000000000
          Height = 19.275590550000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -12
  ...
  object qryBalanco: TFDQuery
    ...
    Connection = Dados.Conexao
    SQL.Strings = (
      'SELECT CONTA, DATA, NOME, ENTRADA, SAIDA FROM ('
      
        'select '#39'CAIXA E BANCOS'#39' AS CONTA, current_date as data , co.desc' +
        'ricao as nome, sum(cx.entrada-cx.saida) entrada, 0 as Saida from' +
        ' caixa cx'
      'left join contas co on  co.codigo=cx.fkconta'
      'where'
      'co.tipo<>'#39'S'#39' and'
      'cx.emissao<=:data2 and'
      'cx.empresa between :id1 and :id2'
      'group by 1,2,3'
      'having sum(cx.entrada-cx.saida)>0'
      ''
      'union all'
      ''
      
        'select '#39'CAIXA E BANCOS'#39' AS CONTA, current_date as data, co.descr' +
        'icao as nome,0 as entrada,  sum(cx.entrada-cx.saida) as Saida fr' +
        'om caixa cx'
      'left join contas co on  co.codigo=cx.fkconta'
      'where'
      'co.tipo<>'#39'S'#39' and'
      ...
      ''
        ...
        'select '#39'CONTAS '#192' RECEBER'#39' AS CONTA, CR.dtvencimento as data, (cr' +
        '.historico||'#39'-'#39'||pes.fantasia) as nome, cr.vl_restante as entrad' +
        'a, 0 as saida from creceber cR'
      'left join pessoa pes on  pes.codigo=cr.fkcliente'
      'where'
      
        'cR.dtvencimento between :data1 and :data2  AND not(CR.situacao i' +
        'n ('#39'T'#39')) and'
      'cr.fkempresa between :id1 and :id2'
      ''
      'union all'
      ''
      
        'select '#39'CONTAS '#192' PAGAR'#39' AS CONTA, cp.dtvencimento as data, (cp.h' +
        'istorico||'#39'-'#39'||pes.fantasia) as nome,  0 as entrada, cp.vl_resta' +
        'nte as saida from cpagar cp'
      'left join pessoa pes on  pes.codigo=cp.fkfornece'
      'where'
      'not (cp.situacao='#39'T'#39') and'
      'cp.dtvencimento between :data1 and :data2  and'
      'cp.fkempresa between :id1 and :id2'
      ')'
      'order by conta,data')
    Left = 248
    Top = 65533
    ...
    object qryBalancoCONTA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CONTA'
      Origin = 'CONTA'
      ProviderFlags = []
    ...
    object qryBalancoDATA: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'DATA'
      Origin = '"DATA"'
      ProviderFlags = []
    ...
    object qryBalancoENTRADA: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'ENTRADA'
      Origin = 'ENTRADA'
      ProviderFlags = []
    ...
    object qryBalancoSAIDA: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'SAIDA'
      Origin = 'SAIDA'
      ProviderFlags = []
