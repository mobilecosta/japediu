object frmFabricar: TfrmFabricar
  Left = 0
  Top = 0
  ...
  object DBGrid1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        Width = 534
        OnUpdateData = DBGrid1Columns2UpdateData
      end
      item
        CellButtons = <>
        DynProps = <>
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 44108.827634803240000000
    ...
    object Compra: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBClientesCODIGO: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBVendas."ID_PRODUTO"]')
          ParentFont = False
        end
        object Memo14: TfrxMemoView
          AllowVectorExport = True
          Left = 55.559055120000000000
          Top = 3.023622050000000000
          Width = 398.740147720000000000
          Height = 19.200000000000000000
          DataField = 'DESCRICAO'
          DataSetName = 'frxDBVendas'
          Font.Charset = DEFAULT_CHARSET
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBVendas."DESCRICAO"]')
          ParentFont = False
        end
        object Memo5: TfrxMemoView
          AllowVectorExport = True
          Left = 620.999997560000000000
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBVendas."PERCENTUAL"]')
          ParentFont = False
        end
        object Memo6: TfrxMemoView
          AllowVectorExport = True
          Left = 457.212591100000000000
          Top = 3.023622050000000000
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          AllowVectorExport = True
          Top = 95.040940000000000000
          Width = 754.393700790000000000
          Height = 18.897650000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -19
      ...
      object ColumnHeader1: TfrxColumnHeader
        ...
        object Memo17: TfrxMemoView
          AllowVectorExport = True
          Left = 710.213050000000000000
          Top = 3.133858270000000000
          Width = 39.307062200000000000
          Height = 17.280000000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
  ...
  object qryFabricar: TFDQuery
    AfterEdit = qryFabricarAfterEdit
    BeforePost = qryFabricarBeforePost
    AfterPost = qryFabricarAfterPost
    BeforeDelete = qryFabricarBeforeDelete
    AfterDelete = qryFabricarAfterPost
    OnNewRecord = qryFabricarNewRecord
    Connection = Dados.Conexao
    SQL.Strings = (
      'select * from produto_fabricados'
      'where'
    ...
    object qryFabricarCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryFabricarDATA: TDateField
      FieldName = 'DATA'
      Origin = '"DATA"'
    end
    object qryFabricarFK_PRODUTO: TIntegerField
      FieldName = 'FK_PRODUTO'
      Origin = 'FK_PRODUTO'
    end
    object qryFabricarDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 100
    end
    object qryFabricarQUANTIDADE: TFMTBCDField
      FieldName = 'QUANTIDADE'
      Origin = 'QUANTIDADE'
      Precision = 18
      Size = 4
    end
    object qryFabricarVIRTUAL_PRODUTO: TStringField
      FieldKind = fkLookup
    ...
    object qryFabricarNUMERO_NFE: TIntegerField
      FieldName = 'NUMERO_NFE'
      Origin = 'NUMERO_NFE'
    end
  end
  object dsFabricar: TDataSource
    DataSet = qryFabricar
    Left = 128
    Top = 32
  end
  object qryProd: TFDQuery
    Connection = Dados.Conexao
    SQL.Strings = (
      'select codigo, descricao, qtd_atual, pr_venda from produto'
      'where'
      'FABRICADO='#39'S'#39' and empresa=:id'
      'order by descricao')
    Left = 184
    Top = 88
    ParamData = <
