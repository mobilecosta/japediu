object frmRelProdComprados: TfrmRelProdComprados
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsDialog
  Caption = 'Relat'#243'rio Produtos Comprados'
  ClientHeight = 219
  ClientWidth = 358
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 44510.011024293980000000
    ...
    Datasets = <
      ...
      item
        DataSet = frxDBConferencia
        DataSetName = 'frxDBRelComp'
      end>
    Variables = <>
    Style = <>
    ...
    object Compra: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo26: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBRelComp."COD_COMPRA"]')
          ParentFont = False
        end
        object Memo24: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          Left = 685.094930000000000000
          Top = 1.000000000000000000
          Width = 60.472480000000000000
          Height = 15.118120000000000000
      ...
      object ColumnHeader1: TfrxColumnHeader
        ...
        object Memo10: TfrxMemoView
          AllowVectorExport = True
          Left = 542.081150000000000000
          Top = 4.000000000000000000
          Width = 51.477180000000000000
          Height = 13.500470000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
  ...
  object qryRel: TFDQuery
    ...
    SQL.Strings = (
      'select'
      'p.codbarra, p.descricao as nome, g.descricao as grupo,'
      'p.ult_compra cod_compra, i.vl_unitario as Custo_Compra,'
      'c.dtentrada as data_compra, c.nr_nota as numero'
      'from produto p'
      'left join grupo g on g.codigo = p.grupo'
      'left join compra c on c.id = p.ult_compra'
      'left join compra_itens i on  i.fk_produto = p.codigo'
      'where i.fk_compra = c.id and p.grupo between :gp and :gp1'
      'and c.dtentrada between :dat1 and :dat2'
    ...
    object qryRelCODBARRA: TStringField
      FieldName = 'CODBARRA'
      Origin = 'CODBARRA'
    end
    ...
    object qryRelCOD_COMPRA: TIntegerField
      FieldName = 'COD_COMPRA'
      Origin = 'ULT_COMPRA'
      Required = True
    end
    object qryRelDATA_COMPRA: TDateField
      AutoGenerateValue = arDefault
    ...
    object qryRelCUSTO_COMPRA: TFMTBCDField
      AutoGenerateValue = arDefault
