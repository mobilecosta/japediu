...
begin
  ...
  WebCharts1.BackgroundColor('#F8F8FA').FontColor('#585858').Container(Fluid)
    ...
    '</span> ' + '</div>').&End._Div.ColSpan(3)
    .Add('<div class="box primary">  ' + '<span class="count_top">' +
    '  <i class="fa fa-archive"></i> Lucro Mês Atual ' + '</span>' +
    ...
    .DataSet.textLabel('Vendas - Mês Atual').DataSet(ClientDataSetGraficoLine)
    .LabelName('DATA').ValueName('VALOR').BackgroundColor('82,115,233')
    .BorderColor('82,115,233').&End.DataSet.textLabel('Vendas - Mês Anterior')
    ...
    .&End.Title.Text('Caixa Geral - Entrada/Saída de Hoje').display(True)
    ...
    .DataSet.textLabel('Contas á Receber').DataSet(ClientDataSetCR)
    .LabelName('CASE').ValueName('VALOR').BackgroundColor('82,115,233')
    .BorderColor('82,115,233').&End.DataSet.textLabel('Contas á Pagar')
