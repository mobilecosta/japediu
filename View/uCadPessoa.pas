...
begin
  ...
  begin
    ...
    ValorCNPJ := trim(Dados.qryPessoasCNPJ.Value);
    ...
    begin
      ...
      else if Dados.qryPessoasTIPO.Value = 'FÍSICA' then
      begin
...
begin
  Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Cadastro de Pessoas';
end;
...
begin
  ...
  qryVendedores.close;
  qryVendedores.Params[0].Value := Dados.qryEmpresaCODIGO.Value;
  qryVendedores.Open;
