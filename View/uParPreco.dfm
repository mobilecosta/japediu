object frmPrecoAlterado: TfrmPrecoAlterado
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Produto Pre'#231'o Alterado'
  ClientHeight = 189
  ClientWidth = 372
  Color = clBtnFace
  ...
  object qryProduto: TFDQuery
    ...
    SQL.Strings = (
      'select codigo, descricao, localizacao, pr_venda from produto'
      'where'
      'data_preco between :data1 and :data2 and'
      'empresa=:empresa'
      'order by localizacao, descricao')
    Left = 224
    Top = 112
    ParamData = <
      item
    ...
    object qryProdutoLOCALIZACAO: TStringField
