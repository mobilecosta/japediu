object frmRelVendasLotes: TfrmRelVendasLotes
  Left = 0
  Top = 0
  Caption = 'Par'#226'metros - Vendas por Lotes'
  ClientHeight = 208
  ClientWidth = 372
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 44607.516453148150000000
    ...
    Datasets = <
      ...
      item
        DataSet = frxDBVendasD
        DataSetName = 'frxDBVendasD'
      end
      item
        DataSet = frxDBVendasL
        DataSetName = 'frxDBVendasL'
      end>
    Variables = <>
    Style = <>
    ...
    object Compra: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo14: TfrxMemoView
          ...
          Fill.BackColor = clSilver
          Memo.UTF8W = (
            '[frxDBVendas."DATA_EMISSAO"]')
          ParentFont = False
        end
        object Memo15: TfrxMemoView
          AllowVectorExport = True
          Left = 175.370078740000000000
          Width = 486.803149610000000000
          Height = 17.280000000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -12
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIO DE VENDAS POR LOTES - DETALHADO')
          ParentFont = False
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo21: TfrxMemoView
          AllowVectorExport = True
          Left = 378.255040000000000000
          Top = 3.600000000000000000
          Width = 274.544960000000000000
          Height = 17.280000000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -12
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'Total de Geral de Lotes>>>')
          ParentFont = False
        end
        object SysMemo5: TfrxSysMemoView
          AllowVectorExport = True
          Left = 654.840000000000000000
          Top = 3.600000000000000000
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxDBVendasL."QTD">,DetailData1)]')
          ParentFont = False
        end
      end
      ...
      object DetailData1: TfrxDetailData
        ...
        DataSet = frxDBVendasL
        DataSetName = 'frxDBVendasL'
        Filter = '<frxDBVendasL."FK_VENDA">=<frxDBVendas."CODIGO">'
        RowCount = 0
        ...
        object Memo32: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBVendasL."DESCRICAO"]')
          ParentFont = False
        end
        object Memo34: TfrxMemoView
          AllowVectorExport = True
          Left = 283.842519690000000000
          Width = 378.330708660000000000
          Height = 17.280000000000000000
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -12
      ...
      object Footer1: TfrxFooter
        ...
        object Memo9: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'Total de Lotes p/ essa venda >>>')
          ParentFont = False
        end
        object SysMemo4: TfrxSysMemoView
          AllowVectorExport = True
          Left = 650.653228350000000000
          Width = 104.640000000000000000
          Height = 17.385826770000000000
          DisplayFormat.FormatStr = '%2.2f'
          DisplayFormat.Kind = fkNumeric
  ...
  object qryDiario: TFDQuery
    ...
    Connection = Dados.Conexao
    SQL.Strings = (
      'select fpg.descricao, sum(vf.TOTAL)valor from vendas_fpg vf'
      'left join forma_pagamento fpg on fpg.codigo=vf.id_forma'
      'left join vendas_master vm on vm.codigo=vf.vendas_master'
      'where'
      
        'vf.situacao='#39'F'#39' and vm.data_emissao between :data1 and :data2 an' +
        'd vf.tipo<>'#39'T'#39' and vf.total>0'
      '/*where*/'
      'group by 1'
      'order by 1')
    Left = 176
    ...
    object qryDiarioVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      DisplayFormat = ',0.00'
      Precision = 18
  ...
  object qryDiarioD: TFDQuery
    AggregatesActive = True
    Connection = Dados.Conexao
    SQL.Strings = (
      
        'select fpg.descricao, vm.codigo, vm.data_emissao, co.descricao a' +
        's caixa, usu.login, vf.total as valor from vendas_fpg vf'
      ' left join forma_pagamento fpg on fpg.codigo=vf.id_forma'
      ' left join vendas_master vm on vm.codigo=vf.vendas_master'
      ...
      ' where'
        ...
        ' vf.situacao='#39'F'#39' and vm.data_emissao between :data1 and :data2 a' +
        'nd vf.tipo<>'#39'T'#39' and vf.total>0'
      ' /*where*/'
      ' order by fpg.descricao, vm.codigo')
    Left = 288
    Top = 85
    ParamData = <
      item
    ...
    object qryDiarioDDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 30
    end
    object qryDiarioDCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object qryDiarioDDATA_EMISSAO: TDateField
      FieldName = 'DATA_EMISSAO'
      Origin = 'DATA_EMISSAO'
    end
    object qryDiarioDCAIXA: TStringField
      FieldName = 'CAIXA'
      Origin = 'CAIXA'
      Size = 40
    end
    object qryDiarioDLOGIN: TStringField
      FieldName = 'LOGIN'
      Origin = 'LOGIN'
      Size = 10
    end
    object qryDiarioDVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      DisplayFormat = ',0.00'
      Precision = 18
  ...
  object frxDBFPGD: TfrxDBDataset
    UserName = 'frxDBFPGD'
    CloseDataSource = False
    FieldAliases.Strings = (
      'DESCRICAO=DESCRICAO'
  ...
  object qryVendas: TFDQuery
    ...
    SQL.Strings = (
      ...
      'where (vm.situacao='#39'F'#39') /*where*/'
  ...
  object qryVendasD: TFDQuery
    ...
    object qryVendasDFKVENDA: TIntegerField
      FieldName = 'FKVENDA'
      Origin = 'FKVENDA'
      Required = True
    end
    ...
    object qryVendasDE_MEDIO: TFMTBCDField
      FieldName = 'E_MEDIO'
      Origin = 'E_MEDIO'
      Precision = 18
      Size = 2
    ...
    object qryVendasDTOTAL: TFMTBCDField
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      Precision = 18
      Size = 2
    end
    object qryVendasDSITUACAO: TStringField
      FieldName = 'SITUACAO'
      Origin = 'SITUACAO'
      Size = 1
    end
    ...
    object qryVendasDQTD_DEVOLVIDA: TFMTBCDField
      FieldName = 'QTD_DEVOLVIDA'
      Origin = 'QTD_DEVOLVIDA'
      Precision = 18
      Size = 3
    end
    object qryVendasDACRESCIMO: TFMTBCDField
      FieldName = 'ACRESCIMO'
      Origin = 'ACRESCIMO'
      Precision = 18
      Size = 2
    end
    object qryVendasDOS: TStringField
      FieldName = 'OS'
      Origin = 'OS'
      Size = 1
    end
    object qryVendasDFK_GRADE: TIntegerField
      FieldName = 'FK_GRADE'
      Origin = 'FK_GRADE'
    end
    object qryVendasDID_PRODUTO_SIMILAR: TIntegerField
      FieldName = 'ID_PRODUTO_SIMILAR'
      Origin = 'ID_PRODUTO_SIMILAR'
    end
    object qryVendasDID_SERIAL: TIntegerField
      FieldName = 'ID_SERIAL'
      Origin = 'ID_SERIAL'
    end
    object qryVendasDFK_MESA: TIntegerField
      FieldName = 'FK_MESA'
      Origin = 'FK_MESA'
    end
    object qryVendasDQTD_RESTANTE: TFMTBCDField
      FieldName = 'QTD_RESTANTE'
      Origin = 'QTD_RESTANTE'
      Precision = 18
      Size = 3
    end
    object qryVendasDOBSERVACAO: TStringField
      FieldName = 'OBSERVACAO'
      Origin = 'OBSERVACAO'
      Size = 150
    end
    object qryVendasDPR_CUSTO2: TFMTBCDField
      FieldName = 'PR_CUSTO2'
      Origin = 'PR_CUSTO2'
      Precision = 18
      Size = 2
    end
    object qryVendasDFK_LOTE: TIntegerField
      FieldName = 'FK_LOTE'
      Origin = 'FK_LOTE'
    end
    object qryVendasDQTD_BARRAS: TFMTBCDField
  ...
  object frxDBVendasD: TfrxDBDataset
    UserName = 'frxDBVendasD'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CODIGO=CODIGO'
      'FKVENDA=FKVENDA'
  ...
  object qryVendasL: TFDQuery
    Connection = Dados.Conexao
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    SQL.Strings = (
      
        'select vl.*, pl.descricao, pr.descricao produto from vendas_lote' +
        's vl'
      'inner join produto_lotes pl on pl.codigo=vl.fk_lote'
      'inner join produto pr on pr.codigo=pl.fk_produto')
    Left = 336
    Top = 8
    object qryVendasLCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryVendasLFK_VENDA: TIntegerField
      FieldName = 'FK_VENDA'
      Origin = 'FK_VENDA'
    end
    object qryVendasLFK_VENDA_DETALHE: TIntegerField
      FieldName = 'FK_VENDA_DETALHE'
      Origin = 'FK_VENDA_DETALHE'
    end
    object qryVendasLFK_LOTE: TIntegerField
      FieldName = 'FK_LOTE'
      Origin = 'FK_LOTE'
    end
    object qryVendasLQTD: TFMTBCDField
      FieldName = 'QTD'
      Origin = 'QTD'
      Precision = 18
      Size = 3
    end
    object qryVendasLFK_PRODUTO: TIntegerField
      FieldName = 'FK_PRODUTO'
      Origin = 'FK_PRODUTO'
    end
    object qryVendasLDESCRICAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object qryVendasLPRODUTO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'PRODUTO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
  ...
  object frxDBVendasL: TfrxDBDataset
    UserName = 'frxDBVendasL'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CODIGO=CODIGO'
      'FK_VENDA=FK_VENDA'
