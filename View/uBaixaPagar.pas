...
uses
  ...
  DynVarsEh, EhLibVCL, GridsEh, DBAxisGridsEh, ACBrBase, ACBrEnterTab, dxSkinDevExpressDarkStyle, cxGraphics, cxLookAndFeels,
...
procedure TfrmBaixaPagar.cxGravarClick(Sender: TObject);
var
...
procedure TfrmBaixaPagar.cxSairClick(Sender: TObject);
begin
    Close;
end;
...
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Baixar - Contas à Pagar';
end;
