...
var
  ...
  Tentativas: Integer;
const
  MaxTentativas = 3; // Defina o número máximo de tentativas aqui
...
//  Dados.aMenu := 'MnSoftHouse';
    ...
    Senha := InputBox('Autenticação', 'Informe sua senha Parceiro:', '');
    ...
    try
      ...
      Break; // A senha está correta, saia do loop
    end
    else
    begin
      Inc(Tentativas);
...
begin
  ...
  Dados.aMenu := 'MnSoftHouse';
    ...
    Senha := InputBox('Autenticação', 'Informe sua senha SoftHouse:', '');
...
begin
  ...
  begin
    Align := alClient;
    FTDI := TTDI.Create(self, TFrmrecibo);
  end
  else
    FTDI.MostrarFormulario(TFrmrecibo, false);
end;
