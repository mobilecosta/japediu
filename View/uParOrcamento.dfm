object frmParOrcamento: TfrmParOrcamento
  Left = 0
  Top = 0
  ActiveControl = cbEmpresa
  BorderStyle = bsDialog
  Caption = 'Par'#226'metros - Or'#231'amento'
  ClientHeight = 275
  ClientWidth = 309
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43144.465335312510000000
    ...
    Datasets = <
      ...
      item
        DataSet = FrmParametros.frxDBRel
    ...
    object Compra: TfrxReportPage
      ...
      object Totais: TfrxReportSummary
        ...
        object SysMemo4: TfrxSysMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[SUM(<frxDBRel."TOTAL">,MasterData1)]')
          ParentFont = False
        end
      end
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'HIST'#211'RICO DE VENDAS - RESUMO')
          ParentFont = False
        end
  ...
  object qryOrcamento: TFDQuery
    Connection = Dados.Conexao
    SQL.Strings = (
      'select orc.*, ve.nome vendedor from orcamento orc'
      'left join vendedores ve on ve.codigo=orc.fkvendedor'
      'where'
      '(orc.data between :data1 and :data2)'
      '/*where*/')
    Left = 176
    Top = 200
    ParamData = <
