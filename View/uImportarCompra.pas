              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    qryItensCompraCSOSN.Value := CSOSNIcmsToStr(Imposto.ICMS.CSOSN);
...
procedure TfrmImportaCompra.FormCreate(Sender: TObject);
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Importar Compra em Lote';
end;
