...
begin
 ...
 filtro1 := '';
    ...
    case idx of
      ...
      2:
        filtro1 := ' WHERE DESCRICAO LIKE ' +
          QuotedStr('%' + UpperCase(edtLoc.Text) + '%');
    end;
  ...
  begin
      ...
      Barra := IntToStr(Dados.CodigoBarra_Aux(edtLoc.Text));


      filtro1 := ' WHERE CODIGO = ' + QuotedStr(Barra);
...
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Pesquisa de Produtos';
end;
