object frmParCSOSNCST: TfrmParCSOSNCST
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Par'#226'metros - Invent'#225'rio CSOSN/CST'
  ClientHeight = 155
  ClientWidth = 416
  Color = clBtnFace
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.LastChange = 43838.387672094900000000
    ...
    object Compra: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo14: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBInventario."CSOSN"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo10: TfrxMemoView
          AllowVectorExport = True
          Left = 371.527559055118000000
          Width = 103.181102362205000000
          Height = 21.165354330000000000
          DataField = 'ENTRADA'
          DataSet = frxDBInventario
          DataSetName = 'frxDBInventario'
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBInventario."ENTRADA"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo17: TfrxMemoView
          AllowVectorExport = True
          Left = 474.708661420000000000
          Width = 103.181102360000000000
          Height = 21.165354330000000000
          DataField = 'SAIDA'
          DataSet = frxDBInventario
          DataSetName = 'frxDBInventario'
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo11: TfrxMemoView
          ...
          Height = 27.840000000000000000
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Fill.BackColor = 16250871
        end
        object SysMemo5: TfrxSysMemoView
          AllowVectorExport = True
          Left = 375.307089060000000000
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBInventario."ENTRADA">,MasterData1)]')
          ParentFont = False
        end
        object SysMemo6: TfrxSysMemoView
          AllowVectorExport = True
          Left = 478.488191420000000000
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBInventario."SAIDA">,MasterData1)]')
          ParentFont = False
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 755.301275200000000000
        Condition = 'frxDBInventario."TIPO"'
        object frxDBInventarioTIPO: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Documento:[frxDBInventario."TIPO"]')
          ParentFont = False
        end
        object Memo7: TfrxMemoView
          AllowVectorExport = True
          Left = 178.393700790000000000
          Top = 20.737650000000000000
          Width = 96.000000000000000000
  ...
  object qryInventario: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select tipo,  cst,  csosn, sum(entrada) as entrada, sum(saida) a' +
        's saida from('
      
        'select '#39'NFCE'#39'as tipo, nfcd.cst, nfcd.csosn, 0 AS ENTRADA, nfcd.t' +
        'otal AS SAIDA  from nfce_detalhe nfcd'
      'left join nfce_master nfcm on nfcm.codigo=nfcd.fkvenda'
      'left join cfop on cfop.codigo=nfcd.cfop'
      'where'
      
        'nfcm.data_emissao between :data1 and :data2 and nfcm.situacao='#39'T' +
        #39
      ''
      'union all'
      ''
      
        'select '#39'NFE'#39' AS TIPO, nfd.cst, nfd.csosn, nfd.total as ENTRADA, ' +
        '0 AS SAIDA from nfe_detalhe nfd'
      'left join nfe_master nfm on nfm.codigo=nfd.fknfe'
      'left join cfop on cfop.codigo=nfd.cfop'
      'where'
      
        'nfm.data_emissao between :data1 and :data2 and cfop.mov_es='#39'E'#39' a' +
        'nd nfm.situacao=2'
      ''
      'union all'
      ''
      
        'select '#39'NFE'#39' as tipo ,nfd.cst, nfd.csosn, 0 AS ENTRADA, nfd.tota' +
        'l AS SAIDA from nfe_detalhe nfd'
      'left join nfe_master nfm on nfm.codigo=nfd.fknfe'
      'left join cfop on cfop.codigo=nfd.cfop'
      'where'
      
        'nfm.data_emissao between :data1 and :data2 and cfop.mov_es='#39'S'#39' a' +
        'nd nfm.situacao=2'
      ''
      'union all'
      ''
      
        'select '#39'COMPRA'#39' as tipo,  ci.cst_icm, pro.csosn, ci.total AS ENT' +
        'RADA, 0 AS SAIDA from compra_itens ci'
      'left join compra co on co.id=ci.fk_compra'
      'left join produto  pro on pro.codigo=ci.fk_produto'
      'where'
      'co.dtentrada between :data1 and :data2 and co.status='#39'F'#39')'
      'group by 1,2,3')
    Left = 192
    Top = 53
    ParamData = <
    ...
    object qryInventarioTIPO: TStringField
    ...
    object qryInventarioENTRADA: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'ENTRADA'
      Origin = 'ENTRADA'
      ProviderFlags = []
    ...
    object qryInventarioSAIDA: TFMTBCDField
      AutoGenerateValue = arDefault
      FieldName = 'SAIDA'
      Origin = 'SAIDA'
      ProviderFlags = []
