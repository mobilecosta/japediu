...
begin
Caption := Dados.qryParametroTITULO_SISTEMA.Value + ' - Atualizador Automático';
...
begin
  ...
  arquivo := ExtractFilePath(Application.ExeName) + 'PDV.exe';
...
begin
  ...
  Caption := 'Finalizado ...';
  lbStatus.Caption := 'Download Finalizado, reinicie o sistema!';
