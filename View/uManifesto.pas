...
begin
  btnGerar.Visible := dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnDesconhecer.Visible := dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnLote.Visible := dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnManifestar.Visible := dados.qryPermissoesBotaoEDITAR.Value = 'S';
  btnChave.Visible := dados.qryPermissoesBotaoEDITAR.Value = 'S';
end;

procedure TFrmManifesto.FormCreate(Sender: TObject);
begin
  Caption := dados.qryParametroTITULO_SISTEMA.Value + ' - Notas de Fornecedor';
