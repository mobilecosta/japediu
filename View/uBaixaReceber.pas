...
implementation
{$R *.dfm}
uses Udados, uVendaCartao, uCadReceber;
...
begin
  ...
  qryCR.Post;
if (dados.truncar(qryRecebimentoTSALDO.asFloat, 3)) >= 0.02 then
             begin
                 if qryCRSITUACAO.Value = 'P' then
                    ...
                    frmCadReceber.qrycrFKCLIENTE.Value := qrycrFKCLIENTE.Value;
                    ...
                    frmCadReceber.qrycrVALOR.Value := qryRecebimentoTSALDO.asFloat - qryRecebimentoVALOR_RECEBIDO.asFloat;
...
procedure TfrmBaixaReceber.cxGravarClick(Sender: TObject);
var
...
procedure TfrmBaixaReceber.cxSairClick(Sender: TObject);
begin
  Close;
end;
