...
uses
  ...
  uCredenciadora in '..\View\uCredenciadora.pas' {frmCredenciadora},
  ...
  uTribNCM in '..\View\uTribNCM.pas' {frmBuscaTribNCM},
  uCadTribNCM in '..\View\uCadTribNCM.pas' {frmCadTribNcm},
  uBuscaNCM in '..\View\uBuscaNCM.pas' {frmBuscaNCM},
  uConsultaEstado in '..\View\uConsultaEstado.pas' {frmConsEstado},
  uConsCFOP in '..\View\uConsCFOP.pas' {frmConsultaCFOP},
  uConsultaCST in '..\View\uConsultaCST.pas' {frmConsultaCST},
  uConsPisCofins in '..\View\uConsPisCofins.pas' {frmConsultaPisCofins},
  uConsultaIPI in '..\View\uConsultaIPI.pas' {frmConsultaIPI},
  uNfeEntrada in '..\View\uNfeEntrada.pas' {frmNFeEntrada},
  ...
  Upadrao in '..\View\Upadrao.pas' {frm_dashboard},
  uPrincipio_Ativo in '..\View\uPrincipio_Ativo.pas' {frmPrincipio},
  uAcertaGrupo in '..\View\uAcertaGrupo.pas' {FrmAcertaGrupo},
  uRelProdComprados in '..\View\uRelProdComprados.pas' {frmRelProdComprados},
  UImpactoVenda in '..\View\UImpactoVenda.pas' {FrmImpacto},
  ULucratividade in '..\View\ULucratividade.pas' {FrmLucratividade},
  uProdutosVencidos in '..\View\uProdutosVencidos.pas' {FrmProdutosVencidos},
  UAniversariante in '..\View\UAniversariante.pas' {FrmAniversariante},
  USugestaoCompras in '..\View\USugestaoCompras.pas' {FrmSugestaoCompra},
  uBalancoEstoque in '..\View\uBalancoEstoque.pas' {FrmBalanco},
  uParAuditoria in '..\View\uParAuditoria.pas' {FrmParAudi},
  ...
  uAcertaEstoqueExpresso in '..\View\uAcertaEstoqueExpresso.pas' {frmAcertaEstoqueExpresso},
  uCorrigirEstoqueFiscal in '..\View\uCorrigirEstoqueFiscal.pas' {frmCorrigirEstoqueFiscal},
  uGuardaEstoque in '..\View\uGuardaEstoque.pas' {frmGuardaEstoque},
  uHistProduto in '..\View\uHistProduto.pas' {frmHistProduto},
  uEtiquetasFast in '..\View\uEtiquetasFast.pas' {frmEtiquetasFast},
  uES in '..\View\uES.pas' {frmES},
  UManutencaoProd in '..\View\UManutencaoProd.pas' {FRmManutencaoProd},
  UAtualizaPromocaoGrupo in '..\View\UAtualizaPromocaoGrupo.pas' {FrmAtuPromocaoG},
  URepasseNCMG in '..\View\URepasseNCMG.pas' {FrmRepasseNCM},
  URepassarPrecoG in '..\View\URepassarPrecoG.pas' {FrmRepassarPrecoG},
  uOperacoes in '..\View\uOperacoes.pas' {frmOperacoes},
  UGerenciarGarantias in '..\View\UGerenciarGarantias.pas' {FrmGerenciarGarantias},
  UConsTrocaCred in '..\View\UConsTrocaCred.pas' {FrmConsTrocaCred},
  ...
  uHistoricoProdutoFornecedor in '..\View\uHistoricoProdutoFornecedor.pas' {frmHistoricoProdutoFornecedor},
  uLoteCompra in '..\View\uLoteCompra.pas' {FrmLoteCo},
  uPix in '..\View\uPix.pas' {FrmPix},
  UQrCodePix in '..\View\UQrCodePix.pas' {frmQrCodePix},
  uResumosCaixas in '..\View\uResumosCaixas.pas' {frmResumosCaixas},
  uRelVendasLotes in '..\View\uRelVendasLotes.pas' {frmRelVendasLotes},
  ...
  uGeradorPixSoftHouse in '..\View\Matheus\uGeradorPixSoftHouse.pas' {frmGeradorPixSoftHouse},
  uAguardarGeracaoPix in '..\View\Matheus\uAguardarGeracaoPix.pas' {frmAguardarGeracaoPix},
  uAPIPixMercadoPago in '..\View\Matheus\uAPIPixMercadoPago.pas',
  uPartner in '..\View\Matheus\uPartner.pas' {frmPartner},
  GerarJsonPix in '..\View\Matheus\GerarJsonPix.pas',
  Pkg.Json.DTO in '..\View\Matheus\Pkg.Json.DTO.pas',
  ...
  dataloadproduct in '..\View\Matheus\GTIN\dataloadproduct.pas',
  Pkg.Json in '..\View\Matheus\GTIN\Pkg.Json.pas',
  uEncarte in '..\View\Matheus\uEncarte.pas' {frmEncarte};
...
begin
  ...
  Application.CreateForm(TfrmGeradorPixSoftHouse, frmGeradorPixSoftHouse);
  Application.CreateForm(TfrmEtiquetasFast, frmEtiquetasFast);
  Application.CreateForm(TFrmTEF, FrmTEF);
  Application.CreateForm(TfrmEncarte, frmEncarte);
  Application.Run;
